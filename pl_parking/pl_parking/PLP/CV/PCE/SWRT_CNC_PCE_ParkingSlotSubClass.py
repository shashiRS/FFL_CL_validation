...
@teststep_definition(
    step_number=1,
    name="SWRT_CNC_PCE_ParkingSlotSubClass",
...
class PCEParkingSlotSubclassTestStep(TestStep):
    ...
    def process(self):
        ...
        for camera in check_cameras:
            ...
            for det in range(0, 64):
                ...
                signal_check.append(f"parking_slot_subclass_id_of_{camera}_det_{det}")
        ...
        eval_0 = "Ensures that the component provides subclass confidence for all parking slot detections in each frame"
                ...
                if poly_detections[cam] is True:
                    ...
                    if availability_of_associated_detections[cam] is True:
                        ...
                        if validity_of_keypoints and not df_filtered.empty:
                            ...
                            ) = ft.check_parking_slot_subclass_confidence(
                                df_filtered, cam, ef, dict_obj_keypoints[cam], "subclass"
                            )
                            if valid_subclass_confidence:  # if subclass confidence is valid
                                # check whether the most confident subclass is provided for polynomial detections.
                                valid_det_subclass, invalid_subclass_timestamps = ft.valid_poly_subclass(
                    ...
                    # when there is no polynomial detections available in recording or GT
                    result_subclass_id[cam] = fc.NOT_ASSESSED
        ...
        for camera in check_cameras:
            ...
            if (
                ...
                fig_subclass_id.layout = go.Layout(
                    ...
                    title=f"{camera.swapcase()} Valid parking slots Subclass ID",
                )
        ...
        result_df = {
            ...
            fc.REQ_ID: ["2352739", "2261314"],
            fc.TESTCASE_ID: ["69330"],
...
@verifies("L3_PCE_2352739, L3_PCE_2261314")
@testcase_definition(
    name="SWRT_CNC_PCE_ParkingSlotSubClass",
...
class PCEParkingSlotSubclass(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            PCEParkingSlotSubclassTestStep,
        ]
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    # )
    # test_bsigs = r"D:\csv's\2024.12.04_at_14.10.47_camera-mi_9056\2024.12.04_at_14.10.47_camera-mi_9056.bsig"
    test_bsigs = r"D:\csv's\OD_Bsigs\2024.12.18_at_13.54.55_camera-mi_9056.bsig"
    debug(
        PCEParkingSlotSubclass,
        test_bsigs,
        temp_dir=temp_dir,
