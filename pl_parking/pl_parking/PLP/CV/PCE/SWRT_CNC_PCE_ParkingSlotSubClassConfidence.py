...
@teststep_definition(
    step_number=1,
    name="SWRT_CNC_PCE_ParkingSlotSubClassConfidence",
...
class PCEParkingSlotSubClassConfidenceTestStep(TestStep):
                    ...
                    if availability_of_associated_detections[cam] is True:
                        ...
                        if validity_of_keypoints and not df_filtered.empty:
                            ...
                            if valid_subclass_confidence:  # if subclass confidence is valid
                                ...
                                evaluation_result[cam] = (
                                    f"Most Confident subclass is not provided at timestamps: {invalid_subclass_conf_timestamps}"
                                )
...
class PCEParkingSlotSubClassConfidence(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            PCEParkingSlotSubClassConfidenceTestStep,
        ]
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        PCEParkingSlotSubClassConfidence,
        test_bsigs,
        temp_dir=temp_dir,
