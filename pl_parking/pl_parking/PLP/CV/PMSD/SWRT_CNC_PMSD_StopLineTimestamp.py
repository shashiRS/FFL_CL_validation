...
class PmsdStoplinesTimestampTestStep(TestStep):
    ...
    def process(self):
        ...
        signal_summary["FC_Stoplines_Timestamp"] = evaluation[0]
        signal_summary["RC_Stoplines_Timestamp"] = evaluation[1]
        signal_summary["LSC_Stoplines_Timestamp"] = evaluation[2]
        signal_summary["RSC_Stoplines_Timestamp"] = evaluation[3]
