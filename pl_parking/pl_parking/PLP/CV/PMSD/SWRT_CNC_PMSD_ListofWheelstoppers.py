...
class PmsdListWheelstoppersTestStep(TestStep):
    ...
    def process(self):
        ...
        signal_summary = pd.DataFrame(
            {
                "Evaluation": {
                    "1": "Front Camera Wheelstoppers Detections should be present",
                    "2": "Rear Camera Wheelstoppers Detections should be present",
                    "3": "Left Camera Wheelstoppers Detections should be present",
                    "4": "Right Camera Wheelstoppers Detections should be present",
                },
                "Result": {
                    "1": evaluation[0],
                    "2": evaluation[1],
        ...
        sig_sum = fh.build_html_table(signal_summary, table_title="PMSD List of Wheelstoppers")
