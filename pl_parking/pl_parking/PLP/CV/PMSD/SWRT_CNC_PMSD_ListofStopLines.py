...
class PmsdListstoplinesTestStep(TestStep):
    ...
    def process(self):
        ...
        signal_summary = pd.DataFrame(
            {
                "Evaluation": {
                    "1": "Front Camera Stop Line Detections should be present",
                    "2": "Rear Camera Stop Line Detections should be present",
                    "3": "Left Camera Stop Line Detections should be present",
                    "4": "Right Camera Stop Line Detections should be present",
                },
                "Result": {
                    "1": evaluation[0],
                    "2": evaluation[1],
        ...
        sig_sum = fh.build_html_table(signal_summary, table_title="PMSD List of Stop Lines")
