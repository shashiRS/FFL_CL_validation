...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        m_tceEstimationPort = "m_tceEstimationPort"
    ...
    def __init__(self):
        ...
        self._properties = {
            self.Columns.m_tceEstimationPort: [
                ".TCE_0.m_tceEstimationPort.sSigHeader.eSigStatus",
            ],
        }
...
@teststep_definition(
    step_number=1,
    name="TCE_0 Regression test",  # this would be shown as a test step name in html report
    description=("Check that Sig Status for TCE_0 component is not error"),
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
)
@register_signals(SIGNAL_DATA, Signals)
class TestStepTCE_0(ft_helper.BaseStepRregressionTS):
...
@testcase_definition(
    name="TCE_0 Regression Test",
    description=("Check Sig Status for TCE_0 component"),
)
