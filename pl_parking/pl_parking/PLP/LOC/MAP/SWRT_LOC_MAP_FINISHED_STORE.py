...
SIGNAL_DATA = "FINISHED_STORE"
loc_signal = MAP_Signals()


@teststep_definition(
    step_number=1,
    name="LOC-MAP FINISHED Store state",
...
class TestStepFtLOCOutputFINISHEDStore(TestStep):
    """Transitions from the FINISHED state,
    when store event received, map shall move from finished state to finished state
    """
...
@testcase_definition(
    ...
    "=https%3A%2F%2Fjazz.conti.de%2Frm4%2Fresources%2FBI_brMIY1YaEe-WGbhflTJCAg&vvc.configuration"
...
class FtLOCOutputFINISHEDStore(TestCase):
    """Example test case."""
    ...
    def test_steps(self):
        ...
        return [TestStepFtLOCOutputFINISHEDStore]
