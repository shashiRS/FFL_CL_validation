...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_122_Req_2325978_2326033"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 122 Req 2325978 2326033",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP reversible error \
            (the the ACC failed) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_122_Req_2325978_2326033_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            signals["status_acc_state"] = acc_state.apply(lambda x: "ACC_ACTIVE" if x == 3 else "ACC_INACTIVE")
            ...
            time_threshold_2 = find_time_threshold(acc_state, 3)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.ACC_STATE} == ACC_ACTIVE(3):<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.ACC_STATE} == ACC_ACTIVE(3) was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_122_Req_2325978_2326033",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP reversible error \
            (the the ACC failed) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_122_Req_2325978_2326033_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_122_Req_2325978_2326033_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.accInformationPort_accStatus_nu</em> == ACC_ACTIVE(3) <br><br>
            </td>
        </tr>
        <tr>
            <td>
