"""RA Mode Transition, Precondition Mode to Automated Reversing, selected on HMI"""
...
class ValidationSignals(MDFSignalDefinition):
    ...
    def __init__(self):
        ...
        self._properties = {
            ...
            self.Columns.RA_POSS: "MTS.AP_Private_CAN.AP_Private_CAN.APHMIInGeneral1.APHMIGeneralRevAssistPoss",
...
@teststep_definition(
    ...
    description="Check RA function switches from Precondition Mode to Automated Reversing if selected on HMI.",
    expected_result=BooleanResult(TRUE),
)
@register_signals(SIGNAL_DATA, ValidationSignals)
class AupRaPreToAutCheckHMI(TestStep):
    """AupRaPreToAutCheckHMI Test Step."""
    ...
    def process(self, **kwargs):
        ...
        signal_summary[
            "Required RA state change: Precondition Mode to Automated Reversing. Reason: selected on HMI"
        ] = evaluation1
...
@testcase_definition(
    name="RA Mode Transition, Precondition Mode to Automated Reversing, selected on HMI",
    description="The RA function shall transit from Automated Reversing Precondition Mode to Automated Reversing if selected on HMI.",
)
class AupRaPreToAutHMI(TestCase):
    """AupRaPreToAutHMI Test Case."""
