...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_139_Req_2325987_2711725_2325998"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        FRONT_CAM = "SignalManipulation.healthVector_rearCamPreProcUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 139 Req 2325987 2711725 2325998",
    description=(
...
class SWRT_CNC_AUP_ManeuveringState_Table_139_Req_2325987_2711725_2325998_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            rear_cam = signals[Signals.Columns.FRONT_CAM]
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_139_Req_2325987_2711725_2325998",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the rear camera pre-processing is unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_139_Req_2325987_2711725_2325998_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_139_Req_2325987_2711725_2325998_TS
