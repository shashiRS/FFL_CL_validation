...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_143_Req_2325987_2711725_2326002"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        FRONT_USS = "SignalManipulation.healthVector_frontUltrasonicsUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 143 Req 2325987 2711725 2326002",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the front ultrasonics are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_143_Req_2325987_2711725_2326002_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            front_uss = signals[Signals.Columns.FRONT_USS]
            ...
            time_threshold_2 = find_time_threshold(front_uss, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.FRONT_USS} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.FRONT_USS} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=front_uss,
                    mode="lines",
                    name=Signals.Columns.FRONT_USS,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_143_Req_2325987_2711725_2326002",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the front ultrasonics are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_143_Req_2325987_2711725_2326002_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_143_Req_2325987_2711725_2326002_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_frontUltrasonicsUnreliable</em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
