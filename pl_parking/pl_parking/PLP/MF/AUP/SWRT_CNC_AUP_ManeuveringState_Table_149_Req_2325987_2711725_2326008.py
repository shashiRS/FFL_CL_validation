...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_149_Req_2325987_2711725_2326008"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        MF_MANAGER = "SignalManipulation.healthVector_mfManagerFailed"
...
@teststep_definition(
    ...
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            ( the MFManager failed) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_149_Req_2325987_2711725_2326008_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            mf_manager = signals[Signals.Columns.MF_MANAGER]
            ...
            time_threshold_2 = find_time_threshold(mf_manager, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.MF_MANAGER} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.MF_MANAGER} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=mf_manager,
                    mode="lines",
                    name=Signals.Columns.MF_MANAGER,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_149_Req_2325987_2711725_2326008",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            ( the MFManager failed) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_149_Req_2325987_2711725_2326008_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_149_Req_2325987_2711725_2326008_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_mfManagerFailed</em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
