...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_107_Req_2325977_2326004"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 107 Req 2325977 2326004",
    description=(
...
class SWRT_CNC_AUP_ManeuveringState_Table_107_Req_2325977_2326004_TS(TestStep):
        ...
        try:
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.STATIC_OBJ} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.STATIC_OBJ} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_107_Req_2325977_2326004",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (the environmental model static objects are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_107_Req_2325977_2326004_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_107_Req_2325977_2326004_TS
