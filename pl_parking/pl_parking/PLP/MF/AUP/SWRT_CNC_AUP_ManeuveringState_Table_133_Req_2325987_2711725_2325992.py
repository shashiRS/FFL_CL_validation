...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_133_Req_2325987_2711725_2325992"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        COM_ERR = "SignalManipulation.healthVector_hmiCommunicationError"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 133 Req 2325987 2711725 2325992",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            ( the host platform has an Hmi communication error) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_133_Req_2325987_2711725_2325992_TS(TestStep):
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_133_Req_2325987_2711725_2325992",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            ( the host platform has an Hmi communication error) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_133_Req_2325987_2711725_2325992_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_133_Req_2325987_2711725_2325992_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_hmiCommunicationError</em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
