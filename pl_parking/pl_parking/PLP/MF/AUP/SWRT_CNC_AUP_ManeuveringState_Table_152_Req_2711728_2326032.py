...
T2:
SignalManipulation.laDMCStatusPort_laDMCSystemState_nu = 0
...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_152_Req_2711728_2326032"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        LA_DMC = "SignalManipulation.laDMCStatusPort_laDMCSystemState_nu"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 152 Req 2711728 2326032",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Terminate state and it receives the \
            information that a reversible error is present (LaActor reports a reversible error) then it should transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_152_Req_2711728_2326032_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            la_dmc = signals[Signals.Columns.LA_DMC]
            ...
            time_threshold_2 = find_time_threshold(la_dmc, 0)
            ...
            if time_threshold_2 is not None:
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger value {Signals.Columns.LA_DMC} == 0 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_152_Req_2711728_2326032",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Terminate state and it receives the \
            information that a reversible error is present (LaActor reports a reversible error) then it should transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_152_Req_2711728_2326032_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_152_Req_2711728_2326032_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.laDMCStatusPort_laDMCSystemState_nu</em> == 0 <br>
                T3:<br>
