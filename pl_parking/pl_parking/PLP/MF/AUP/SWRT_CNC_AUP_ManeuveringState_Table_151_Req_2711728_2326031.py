...
T2:
SignalManipulation.loDMCStatusPort_loDMCSystemState_nu = 0
...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_151_Req_2711728_2326031"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        LO_DMC = "SignalManipulation.loDMCStatusPort_loDMCSystemState_nu"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 151 Req 2711728 2326031",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Terminate state and it receives the \
            information that a reversible error is present (LoActor reports a reversible error) then it should transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_151_Req_2711728_2326031_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            lo_dmc = signals[Signals.Columns.LO_DMC]
            ...
            time_threshold_2 = find_time_threshold(lo_dmc, 0)
            ...
            if time_threshold_2 is not None:
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger value {Signals.Columns.LO_DMC} == 0 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_151_Req_2711728_2326031",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Terminate state and it receives the \
            information that a reversible error is present (LoActor reports a reversible error) then it should transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_151_Req_2711728_2326031_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_151_Req_2711728_2326031_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.loDMCStatusPort_loDMCSystemState_nu</em> == 0 <br>
                T3:<br>
