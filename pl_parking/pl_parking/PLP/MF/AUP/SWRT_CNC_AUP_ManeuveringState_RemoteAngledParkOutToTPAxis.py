...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_RemoteAngledParkOutToTPAxis"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Remote Angled ParkOut To TPAxis",
    description=(
        "This test case verifies that in case of Remote Parking out angled the AutomatedParkingCore shall trigger that the path is followed until the target pose AXIS is reached."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_RemoteAngledParkOutToTPAxis_TS(TestStep):
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_RemoteAngledParkOutToTPAxis",
    description=(
        "This test case verifies that in case of Remote Parking out angled the AutomatedParkingCore shall trigger that the path is followed until the target pose AXIS is reached."
    ),
)
# Define the class for test case which will inherit the TestCase class and will return the test steps.
class SWRT_CNC_AUP_ManeuveringState_RemoteAngledParkOutToTPAxis_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_RemoteAngledParkOutToTPAxis_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T4: <em>AP.planningCtrlPort.apStates</em> == AP_AVG_PAUSE (5) <br>
            </td>
        </tr>
        <tr>
            <td>
