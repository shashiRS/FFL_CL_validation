"""React on statick object. System shall brake"""
...
SIGNAL_DATA = "REACT_ON_STATIC_OBJ"
...
class CommonStaticBrakeOnCheck(TestStep):
    """CommonStaticBrakeOnCheck Test Step."""
    ...
    def process(self, **kwargs):
        ...
        if t1_idx is not None:
            ...
            if t2_idx is not None:
                ...
                if t3_idx is not None:
                    ...
                    # Get sRoad of ego vehicle + front of ego vehicle
                    ego_stopped = car_sroad_sig[cnt] + constants.HilCl.CarShape.CAR_R_AXLE_TO_FRONT

                    # Get object position
                    obj_pos = obj_pos_sig[cnt]

                    calculated_distance = round(obj_pos - ego_stopped, 3)

                    if ego_stopped >= obj_pos:
                        eval_cond[0] = False

                        evaluation1 = " ".join(
                            f"The evaluation of {signal_name['Car_sroad']} signal is FAILED, ego vehicle not stopped in time"
                            f" and the distace between ego vehicle and static object is {calculated_distance} m.".split()
                        )
                        ...
                        evaluation1 = " ".join(
                            ...
                            f" Distance between front side of ego vehicle and static object is {calculated_distance} m."
        ...
        signal_summary["React on static object. System shall brake on static object"] = evaluation1
...
class CommonStaticBrakeOn(TestCase):
    """CommonStaticBrakeOn Test Case."""
