...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_147_Req_2325987_2711725_2326006"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        ENV_PARK = "SignalManipulation.healthVector_envModelParkingFeaturesUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 147 Req 2325987 2711725 2326006",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the environmental model parking features are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_147_Req_2325987_2711725_2326006_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            env_park = signals[Signals.Columns.ENV_PARK]
            ...
            time_threshold_2 = find_time_threshold(env_park, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.ENV_PARK} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.ENV_PARK} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_147_Req_2325987_2711725_2326006",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the environmental model parking features are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_147_Req_2325987_2711725_2326006_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_147_Req_2325987_2711725_2326006_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_envModelParkingFeaturesUnreliable</em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
