...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_95_Req_2325977_2325992"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        HMI_COMM = "SignalManipulation.healthVector_hmiCommunicationError"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 95 Req 2325977 2325992",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (host platform has an HMI communication error) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_95_Req_2325977_2325992_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            hmi_comm = signals[Signals.Columns.HMI_COMM]
            ...
            time_threshold_2 = find_time_threshold(hmi_comm, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.HMI_COMM} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.HMI_COMM} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_95_Req_2325977_2325992",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (host platform has an HMI communication error) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_95_Req_2325977_2325992_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_95_Req_2325977_2325992_TS
