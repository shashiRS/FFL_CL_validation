...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_129_Req_2325978_2326040"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 129 Req 2325978 2326040",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP reversible error \
            (the the left camera failed) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_129_Req_2325978_2326040_TS(TestStep):
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_129_Req_2325978_2326040",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP reversible error \
            (the the left camera failed) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_129_Req_2325978_2326040_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_129_Req_2325978_2326040_TS
