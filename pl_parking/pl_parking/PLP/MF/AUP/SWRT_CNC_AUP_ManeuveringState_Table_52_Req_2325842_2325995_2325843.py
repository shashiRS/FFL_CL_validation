...
T2: // rear camera becomes unreliable
SignalManipulation.healthVector_rearCamVisionUnreliable = 1

T3: // heal condition
SignalManipulation.healthVector_rearCamVisionUnreliable = 0
...
AP.apUserInformationPort.generalUserInformation_nu == REAR_CAM_VISION_UNRELIABLE (44)
...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_52_Req_2325842_2325995_2325843"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        REAR_CAM = "SignalManipulation.healthVector_rearCamVisionUnreliable"
    ...
    def __init__(self):
        ...
        self._properties = {
            ...
            self.Columns.REAR_CAM: [
                "SignalManipulation.healthVector_rearCamVisionUnreliable",
            ],
            self.Columns.IGN_ON: [
...
@teststep_definition(
    ...
    description=(
        "This test case verifies that if AUPCore receives the information that the rear camera vision is unreliable, which is \
...
class SWRT_CNC_AUP_ManeuveringState_Table_52_Req_2325842_2325995_2325843_TS(TestStep):
        ...
        try:
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"This confirms that AUPCore received the information that the rear camera was unreliable and then it went into error <br>"
                ...
                delay_pos_user = user_inf.iloc[time_threshold_2 + 10] != aup.HMI_MESSAGE.REAR_CAM_VISION_UNRELIABLE
            ...
            AP.apUserInformationPort.generalUserInformation_nu == REAR_CAM_VISION_UNRELIABLE (44)<br>"""
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_52_Req_2325842_2325995_2325843",
    description=(
        "This test case verifies that if AUPCore receives the information that the rear camera vision is unreliable, which is \
            an irreversible error, AUPCore shall go into error state and stay in this state until the ignition is switched off.\
                Also, information about the reason of the error shall be provided by AUPCore."
...
class SWRT_CNC_AUP_ManeuveringState_Table_52_Req_2325842_2325995_2325843_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_52_Req_2325842_2325995_2325843_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: //rear camera becomes unreliable<br>
                    <em>SignalManipulation.healthVector_rearCamVisionUnreliable</em> == 1 <br>
                T3: //heal condition<br>
                    <em>SignalManipulation.healthVector_rearCamVisionUnreliable</em> == 0 <br>
        ...
        <tr>
            <td>
                ...
                delay 0.1s: <br>
                    ...
                    <em>AP.apUserInformationPort.generalUserInformation_nu</em> == REAR_CAM_VISION_UNRELIABLE (44) <br>
                T2 - T4:<br>
