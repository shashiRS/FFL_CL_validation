...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_108_Req_2325977_2326005"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        MODEL_TRAFFIC = "SignalManipulation.healthVector_envModelTrafficParticiapantsUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 108 Req 2325977 2326005",
    description=(
...
class SWRT_CNC_AUP_ManeuveringState_Table_108_Req_2325977_2326005_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            model_traffic = signals[Signals.Columns.MODEL_TRAFFIC]
            ...
            time_threshold_2 = find_time_threshold(model_traffic, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.MODEL_TRAFFIC} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.MODEL_TRAFFIC} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=model_traffic,
                    mode="lines",
                    name=Signals.Columns.MODEL_TRAFFIC,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_108_Req_2325977_2326005",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (the environmental model traffic participants are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_108_Req_2325977_2326005_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_108_Req_2325977_2326005_TS
