    ...
    def __init__(self):
        ...
        self._properties = {
            ...
            self.Columns.HMI_offered_slot: (
                "MTS.ADC5xx_Device.VD_DATA.IuHmiGeneralInputPort.parkingSpaces.right.scanned_nu[0]"
            ),
        ...
        if t1_idx is not None and t2_idx is not None:
            ...
            if detected_slots == 0:
                evaluation1 = " ".join(
                    ...
                    " There is not offered parking slot on passenger's side during scannig phase. Begining of scanning:"
