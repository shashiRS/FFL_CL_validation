...
class AupRAAutRevToTermStandstill(TestStep):
    """AupRAAutRevToTermStandstill Test Step."""
    ...
    def process(self, **kwargs):
        ...
        for cnt in range(t_aut_rev_idx or 0, len(veh_state_sig)):
        ...
        for cnt in range(t_standstill_idx or 0, len(ra_state)):
        ...
        if t_terminate_idx and t_aut_rev_idx and t_standstill_idx:
            test_result = fc.PASS
            evaluation1 = " ".join(
        ...
        signal_summary[
            "Required AR state change: Automated reversing to Terminate when the vehicle was" " standstill."
        ] = evaluation1
...
@testcase_definition(
    ...
    "the RA function braked the vehicle to standstill.",
)
class AupRAAutRevToTermStand(TestCase):
    """AupRAAutRevToTermStand Test Case."""
