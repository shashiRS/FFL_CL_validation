...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_144_Req_2325987_2711725_2326003"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        REAR_USS = "SignalManipulation.healthVector_rearUltrasonicsUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 144 Req 2325987 2711725 2326003",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the rear ultrasonics are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_144_Req_2325987_2711725_2326003_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            rear_uss = signals[Signals.Columns.REAR_USS]
            ...
            time_threshold_2 = find_time_threshold(rear_uss, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.REAR_USS} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.REAR_USS} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_144_Req_2325987_2711725_2326003",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the rear ultrasonics are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_144_Req_2325987_2711725_2326003_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_144_Req_2325987_2711725_2326003_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_rearUltrasonicsUnreliable </em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
