...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_101_Req_2325977_2325998"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 101 Req 2325977 2325998",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (front camera pre-processing is unreliable) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_101_Req_2325977_2325998_TS(TestStep):
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_101_Req_2325977_2325998",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (front camera pre-processing is unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_101_Req_2325977_2325998_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_101_Req_2325977_2325998_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_frontCamPreProcUnreliable</em> == 1 <br><br>
            </td>
        </tr>
        <tr>
            <td>
