...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_74_Req_2325889_2325890_2326038"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 74 Req 2325889 2325890 2326038",
    description=(
        "This test case verifies that if AUPCore detected that the front camera is blocked (reversible error) \
            AUP will NOT transition from init state to scanning state when the ignition is turned on."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_74_Req_2325889_2325890_2326038_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    f"The evaluation is PASSED because the trigger value {Signals.Columns.FRONT_CAM} == 1 has been found at\
                        timestamp <b>{round(time.iloc[time_threshold_2], 3)}s</b>.<br>"
                    f"This confirms that the front camera is blocked.".split()
                )
                eval_cond_1 = True
            else:
            ...
            expected_val_1 = "SignalManipulation.healthVector_frontCamBlockage = 1"
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_74_Req_2325889_2325890_2326038",
    description=(
        "This test case verifies that if AUPCore detected that the front camera is blocked (reversible error) \
            AUP will NOT transition from init state to scanning state when the ignition is turned on."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_74_Req_2325889_2325890_2326038_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_74_Req_2325889_2325890_2326038_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_frontCamBlockage</em> == 1 <br>
                T3: <br>
