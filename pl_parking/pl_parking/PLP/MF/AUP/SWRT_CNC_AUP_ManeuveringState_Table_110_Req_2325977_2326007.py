...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_110_Req_2325977_2326007"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        AVGA_FAILED = "SignalManipulation.healthVector_avgaFailed"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 110 Req 2325977 2326007",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (the AVGA (automated vehicle guidance arbiter) failed) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_110_Req_2325977_2326007_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            avga_failed = signals[Signals.Columns.AVGA_FAILED]
            ...
            time_threshold_2 = find_time_threshold(avga_failed, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.AVGA_FAILED} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.AVGA_FAILED} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=avga_failed,
                    mode="lines",
                    name=Signals.Columns.AVGA_FAILED,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_110_Req_2325977_2326007",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (the AVGA (automated vehicle guidance arbiter) failed) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_110_Req_2325977_2326007_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_110_Req_2325977_2326007_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_avgaFailed</em> == 1 <br><br>
            </td>
        </tr>
        <tr>
            <td>
