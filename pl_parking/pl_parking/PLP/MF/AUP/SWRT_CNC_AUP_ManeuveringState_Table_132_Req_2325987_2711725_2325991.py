...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_132_Req_2325987_2711725_2325991"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        COM_ERR = "SignalManipulation.healthVector_vehicleCommunicationError"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 132 Req 2325987 2711725 2325991",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            ( the host platform has vehicle communication error) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_132_Req_2325987_2711725_2325991_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            com_err = signals[Signals.Columns.COM_ERR]
            ...
            time_threshold_2 = find_time_threshold(com_err, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.COM_ERR} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.COM_ERR} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_132_Req_2325987_2711725_2325991",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            ( the host platform has vehicle communication error) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_132_Req_2325987_2711725_2325991_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_132_Req_2325987_2711725_2325991_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_vehicleCommunicationError</em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
