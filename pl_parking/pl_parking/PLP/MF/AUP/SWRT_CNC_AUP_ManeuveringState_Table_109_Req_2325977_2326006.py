...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_109_Req_2325977_2326006"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        MODEL_PARK = "SignalManipulation.healthVector_envModelParkingFeaturesUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 109 Req 2325977 2326006",
    description=(
...
class SWRT_CNC_AUP_ManeuveringState_Table_109_Req_2325977_2326006_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            model_park = signals[Signals.Columns.MODEL_PARK]
            ...
            time_threshold_2 = find_time_threshold(model_park, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.MODEL_PARK} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.MODEL_PARK} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=model_park,
                    mode="lines",
                    name=Signals.Columns.MODEL_PARK,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_109_Req_2325977_2326006",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (the environmental model parking features are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_109_Req_2325977_2326006_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_109_Req_2325977_2326006_TS
