...
T2: // front camera pre-proc becomes unreliable
SignalManipulation.healthVector_frontCamPreProcUnreliable = 1

T3: // heal condition
SignalManipulation.healthVector_frontCamPreProcUnreliable = 0
...
AP.apUserInformationPort.generalUserInformation_nu == FRONT_CAM_PRE_PROC_UNRELIABLE (47)
...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_55_Req_2325842_2325998_2325843"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        FRONT_CAM = "SignalManipulation.healthVector_frontCamPreProcUnreliable"
    ...
    def __init__(self):
        ...
        self._properties = {
            ...
            self.Columns.FRONT_CAM: [
                "SignalManipulation.healthVector_frontCamPreProcUnreliable",
            ],
            self.Columns.IGN_ON: [
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 55 Req 2325842 2325998 2325843",
    description=(
        "This test case verifies that if AUPCore receives the information that the front camera pre-processing is unreliable, which is \
...
class SWRT_CNC_AUP_ManeuveringState_Table_55_Req_2325842_2325998_2325843_TS(TestStep):
        ...
        try:
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"This confirms that AUPCore received the information that the front camera pre-processing was unreliable and then it went into error <br>"
                ...
                delay_pos_user = user_inf.iloc[time_threshold_2 + 10] != aup.HMI_MESSAGE.FRONT_CAM_PRE_PROC_UNRELIABLE
            ...
            AP.apUserInformationPort.generalUserInformation_nu == FRONT_CAM_PRE_PROC_UNRELIABLE (47)<br>"""
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_55_Req_2325842_2325998_2325843",
    description=(
        "This test case verifies that if AUPCore receives the information that the front camera pre-processing is unreliable, which is \
            an irreversible error, AUPCore shall go into error state and stay in this state until the ignition is switched off.\
                Also, information about the reason of the error shall be provided by AUPCore."
...
class SWRT_CNC_AUP_ManeuveringState_Table_55_Req_2325842_2325998_2325843_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_55_Req_2325842_2325998_2325843_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: //front camera pre-proc becomes unreliable<br>
                    <em>SignalManipulation.healthVector_frontCamPreProcUnreliable</em> == 1 <br>
                T3: //heal condition<br>
                    <em>SignalManipulation.healthVector_frontCamPreProcUnreliable</em> == 0 <br>
        ...
        <tr>
            <td>
                ...
                delay 0.1s: <br>
                    ...
                    <em>AP.apUserInformationPort.generalUserInformation_nu</em> == FRONT_CAM_PRE_PROC_UNRELIABLE (47) <br>
                T2 - T4:<br>
