"""executing a parking in maneuver so that the ego vehicle reaches the final parking in pose with a maximum amount of strokes, Parallel"""
...
__author__ = "uig14850"
SIGNAL_DATA = "PARK_OT_MAX_MAN_TERM_NUM_OF_STROKES_PARALLEL"
...
class NumOfStokresParallelCheck(TestStep):
    """NumOfStokresParallelCheck Test Step."""
            ...
            if number_of_strokes > constants.HilCl.ApThreshold.AP_G_MAX_NUM_STROKES_PAR_NU:
                ...
                if state_on_hmi_sig[t_end_man_idx] == constants.HilCl.Hmi.ParkingProcedureCtrlState.PPC_SUCCESS:
                    ...
                    evaluation_steps[step_key] = " ".join(
                        ...
                        f" this values is greater than AP_G_MAX_NUM_STROKES_PAR_NU ({constants.HilCl.ApThreshold.AP_G_MAX_NUM_STROKES_PAR_NU}) and"
                ...
                if state_on_hmi_sig[t_end_man_idx] == constants.HilCl.Hmi.ParkingProcedureCtrlState.PPC_SUCCESS:
                    ...
                    evaluation_steps[step_key] = " ".join(
                        ...
                        f" Number of strokes is {number_of_strokes} at end of maneuver,"
                        f" this values is not greater than AP_G_MAX_NUM_STROKES_PAR_NU ({constants.HilCl.ApThreshold.AP_G_MAX_NUM_STROKES_PAR_NU}) and"
                        f" {signal_name['State_on_HMI']} signal is PPC_SUCCESS ({constants.HilCl.Hmi.ParkingProcedureCtrlState.PPC_SUCCESS})"
                        f" at end of active maneuver ({time_signal[t_end_man_idx]} us)".split()
                    )
...
@testcase_definition(
    name="Parking Out: Maneuvering to Terminate, Number of strokes exeeds, Parallel parking ",
...
class NumOfStokresParallel(TestCase):
    """NumOfStokresParallel Test Case."""
