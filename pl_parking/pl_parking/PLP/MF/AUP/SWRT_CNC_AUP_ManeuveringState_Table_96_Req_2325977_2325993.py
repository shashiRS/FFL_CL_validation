...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_96_Req_2325977_2325993"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        ODOMETRY = "SignalManipulation.healthVector_odometryUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 96 Req 2325977 2325993",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (odometry is unreliable) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_96_Req_2325977_2325993_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            odometry = signals[Signals.Columns.ODOMETRY]
            ...
            time_threshold_2 = find_time_threshold(odometry, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.ODOMETRY} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.ODOMETRY} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_96_Req_2325977_2325993",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (odometry is unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_96_Req_2325977_2325993_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_96_Req_2325977_2325993_TS
