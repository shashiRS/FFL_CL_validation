...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_148_Req_2325987_2711725_2326007"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        AVGA = "SignalManipulation.healthVector_avgaFailed"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 148 Req 2325987 2711725 2326007",
    description=(
...
class SWRT_CNC_AUP_ManeuveringState_Table_148_Req_2325987_2711725_2326007_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            avga = signals[Signals.Columns.AVGA]
            ...
            time_threshold_2 = find_time_threshold(avga, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.AVGA} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.AVGA} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_148_Req_2325987_2711725_2326007",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            ( the AVGA (automated vehicle guidance arbiter) failed) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_148_Req_2325987_2711725_2326007_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_148_Req_2325987_2711725_2326007_TS
