...
SIGNAL_DATA = "MANEUVER_AREA_CHECK_PERP_F"
...
@teststep_definition(
    name="Checking the maneuvering trajectory perpendicular forward",
    description="Check the maneuvering is correctly happening based on the maneuvering area constrain.",
    expected_result=BooleanResult(TRUE),
)
@register_signals(SIGNAL_DATA, ValidationSignals)
class AupManeuveringAreaPerpFCheck(TestStep):
    """AupManeuveringAreaPerpFCheck Test Step."""
    ...
    def process(self, **kwargs):
        ...
        if t1_idx is not None and t2_idx is not None and t3_idx is not None:
            eval_cond, maneuver_area, ego = HilClFuntions.maneuver_area_check(
                ...
                left_d=constants.HilCl.ManeuveringArea.PERP_IN_F_D_4,
                rear_d=constants.HilCl.ManeuveringArea.PERP_IN_F_D_1,
                right_d=constants.HilCl.ManeuveringArea.PERP_IN_F_D_2,
                front_d=constants.HilCl.ManeuveringArea.PERP_IN_F_D_3,
...
@testcase_definition(
    name="Maneuvering area check perpendicular forward",
...
class AupManeuveringAreaPerpF(TestCase):
