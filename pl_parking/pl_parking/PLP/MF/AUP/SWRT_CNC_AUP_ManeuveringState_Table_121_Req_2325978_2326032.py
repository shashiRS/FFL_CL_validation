...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_121_Req_2325978_2326032"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 121 Req 2325978 2326032",
    description=(
...
class SWRT_CNC_AUP_ManeuveringState_Table_121_Req_2325978_2326032_TS(TestStep):
        ...
        try:
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.LADMC_STATE} == LADMC_NOT_AVAILABLE(0):<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.LADMC_STATE} == LADMC_NOT_AVAILABLE(0) was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_121_Req_2325978_2326032",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP reversible error \
            (the the LoActor failed) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_121_Req_2325978_2326032_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_121_Req_2325978_2326032_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.laDMCStatusPort_laDMCSystemState_nu </em> == LADMC_NOT_AVAILABLE(0) <br><br>
            </td>
        </tr>
        <tr>
            <td>
