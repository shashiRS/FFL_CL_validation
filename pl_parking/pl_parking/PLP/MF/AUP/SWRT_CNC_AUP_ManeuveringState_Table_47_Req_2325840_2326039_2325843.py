...
"AP.apUserInformationPort.generalUserInformation_nu" == {REAR_CAM_BLOCKAGE} (88)
"""
...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_47_Req_2325840_2326039_2325843"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        CAM_BLOCK = "SignalManipulation.healthVector_rearCamBlockage"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 47 Req 2325840 2326039 2325843",
    description=(
        "This test case verifies that if AUPCore receives the information that the rear camera is blocked while  \
...
class SWRT_CNC_AUP_ManeuveringState_Table_47_Req_2325840_2326039_2325843_TS(TestStep):
        ...
        try:
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"- and the signal {Signals.Columns.USER_INF} is in REAR_CAM_BLOCKAGE (88) state<br>"
                    f"This confirms that AUPCore received the information that the rear camera is blocked while in maneuvering state and then <br>"
                    ...
                    f" about the reason of the error, which was 'rear camera blockage'.".split()
                )
                ...
                delay_pos_user = user_inf.iloc[time_threshold_2 + 10] != aup.HMI_MESSAGE.REAR_CAM_BLOCKAGE
                ...
                if (
                    ...
                    if (
                        ...
                        reason = "because <b>before</b> AUPCore detected the rear camera blockage, AUPCore was already in error, the vehicle was stopped and secured<br>\
                        ...
                        reason = " because <b>before</b> AUPCore detected the rear camera blockage, AUPCore wasn't error free."
                    elif delay_neg_br:
                        reason = " because <b>before</b> AUPCore detected the rear camera blockage the vehicle was standstill."
                    elif delay_neg_drv:
                        reason = (
                            " because <b>before</b> AUPCore detected the rear camera blockage the vehicle was secured."
                        )
                    elif delay_pos_core or delay_pos_esm:
                        reason = " because <b>after</b> AUPCore detected the rear camera blockage, AUPCore didn't transition to error state."
                    elif delay_pos_br:
                        reason = " because <b>after</b> AUPCore detected the rear camera blockage the vehicle didn't go standstill."
                    elif delay_pos_drv:
                        reason = " because <b>after</b> AUPCore detected the rear camera blockage the vehicle wasn't secured."
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_47_Req_2325840_2326039_2325843",
    description=(
        "This test case verifies that if AUPCore receives the information that the rear camera is blocked while  \
            in maneuvering state, it shall go into error state and the ego vehicle shall become standstill and it \
                should be secured. Also, the AUPCore shall receive and provide an information about the reason of the error."
...
class SWRT_CNC_AUP_ManeuveringState_Table_47_Req_2325840_2326039_2325843_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_47_Req_2325840_2326039_2325843_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_rearCamBlockage</em> == 1 (3)<br><br>
            </td>
        </tr>
        <tr>
            <td>
                ...
                delay 0.1s: <br>
                    ...
                    <em>AP.apUserInformationPort.generalUserInformation_nu</em> == REAR_CAM_BLOCKAGE (88) <br>
            </td>
        </tr>
    </table>
