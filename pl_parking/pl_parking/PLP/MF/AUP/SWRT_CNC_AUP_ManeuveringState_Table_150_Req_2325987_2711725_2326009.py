...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_150_Req_2325987_2711725_2326009"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        MOCO = "SignalManipulation.healthVector_mocoFailed"
...
class SWRT_CNC_AUP_ManeuveringState_Table_150_Req_2325987_2711725_2326009_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            moco = signals[Signals.Columns.MOCO]
            ...
            time_threshold_2 = find_time_threshold(moco, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.MOCO} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.MOCO} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_150_Req_2325987_2711725_2326009",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the MoCo (Motion Control cluster) failed) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_150_Req_2325987_2711725_2326009_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_150_Req_2325987_2711725_2326009_TS
