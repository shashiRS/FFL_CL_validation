...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_131_Req_2325987_2711725_2325990"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        TEMP_WARN = "SignalManipulation.healthVector_hostTemperatureWarning"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 131 Req 2325987 2711725 2325990",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the host platform has an Temperature warning) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_131_Req_2325987_2711725_2325990_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            temp_warn = signals[Signals.Columns.TEMP_WARN]
            ...
            time_threshold_2 = find_time_threshold(temp_warn, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.TEMP_WARN} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.TEMP_WARN} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=temp_warn,
                    mode="lines",
                    name=Signals.Columns.TEMP_WARN,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_131_Req_2325987_2711725_2325990",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the host platform has an Temperature warning) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_131_Req_2325987_2711725_2325990_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_131_Req_2325987_2711725_2325990_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_hostTemperatureWarning</em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
