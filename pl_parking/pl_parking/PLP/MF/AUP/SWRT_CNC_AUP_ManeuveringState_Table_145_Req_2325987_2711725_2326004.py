...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_145_Req_2325987_2711725_2326004"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        ENV_STAT_OBJ = "SignalManipulation.healthVector_envModelStaticObjsUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 145 Req 2325987 2711725 2326004",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the environmental model static objects are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_145_Req_2325987_2711725_2326004_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            env_stat_obj = signals[Signals.Columns.ENV_STAT_OBJ]
            ...
            time_threshold_2 = find_time_threshold(env_stat_obj, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.ENV_STAT_OBJ} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.ENV_STAT_OBJ} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=env_stat_obj,
                    mode="lines",
                    name=Signals.Columns.ENV_STAT_OBJ,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_145_Req_2325987_2711725_2326004",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the environmental model static objects are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_145_Req_2325987_2711725_2326004_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_145_Req_2325987_2711725_2326004_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_envModelStaticObjsUnreliable  </em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
