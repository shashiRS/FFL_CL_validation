...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_PerpendicularParkOutToCritical"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Perpendicular Park Out To Critical",
    description=(
        "This test case verifies that in case of Parking out perpendicular and the driver is inside the vehicle the AutomatedParkingCore shall trigger that the path is only followed until the critical road-side-edge or the neighboring obstacles is cleared."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_PerpendicularParkOutToCritical_TS(TestStep):
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_PerpendicularParkOutToCritical",
    description=(
        "This test case verifies that in case of Parking out perpendicular and the driver is inside the vehicle the AutomatedParkingCore shall trigger that the path is only followed until the critical road-side-edge or the neighboring obstacles is cleared."
    ),
)
# Define the class for test case which will inherit the TestCase class and will return the test steps.
class SWRT_CNC_AUP_ManeuveringState_PerpendicularParkOutToCritical_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_PerpendicularParkOutToCritical_TS
    ...
    <table>
        ...
        <tr>
            <td>
                ...
                - T2-T3: <em>AP.planningCtrlPort.apPlanningSpecification </em> == APPS_PARK_OUT_UNTIL_CRITICAL_POINT_REACHED (4) <br>
            </td>
        </tr>
    </table>
