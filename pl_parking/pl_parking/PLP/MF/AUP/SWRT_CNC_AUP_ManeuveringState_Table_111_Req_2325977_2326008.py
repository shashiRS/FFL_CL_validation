...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_111_Req_2325977_2326008"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        MF_MANAG = "SignalManipulation.healthVector_mfManagerFailed"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 111 Req 2325977 2326008",
    description=(
...
class SWRT_CNC_AUP_ManeuveringState_Table_111_Req_2325977_2326008_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            mf_manag = signals[Signals.Columns.MF_MANAG]
            ...
            time_threshold_2 = find_time_threshold(mf_manag, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.MF_MANAG} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.MF_MANAG} == 1 was never found.".split()
                )
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_111_Req_2325977_2326008",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (the MFManager failed) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_111_Req_2325977_2326008_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_111_Req_2325977_2326008_TS
