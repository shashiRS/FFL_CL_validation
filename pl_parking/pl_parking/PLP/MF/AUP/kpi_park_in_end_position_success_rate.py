...
ALIAS = "Park_in_end_position_Success_Rate"
    ...
    def process(self, **kwargs):
        ...
        if any(perform_park_in_mask):
            ...
            if any(parking_success_mask):
                """Check if the parking was successful"""
...
def fetch_verdict(verdict):
    """Function which return a string in dependance of the verdict."""
    if verdict:
        return "PASSED"
    else:
        return "FAILED"
...
@teststep_definition(step_number=1, name="PAR", description="Parallel scenario.", expected_result="> 90 %")
...
class Step1(BaseStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            self.result.details["Additional_results"] = f"{exc_type}, {fname}, {exc_tb.tb_lineno}"


@teststep_definition(
    step_number=2, name="PERP/ANG", description="Perpendicular and angular scenario.", expected_result="> 90 %"
)
@register_signals(ALIAS, TestSignals)
...
@verifies("1028834")
@testcase_definition(
    name="Park in end position success rate",
    ...
    doors_url=r"https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Fresources%2FBI_zX-WHOhNEe2m7JKTm3pqog&oslc_config.context=https%3A%2F%2Fjazz.conti.de%2Fgc%2Fconfiguration%2F17099&componentURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Frm-projects%2F_lWHOEPvsEeqIqKySVwTVNQ%2Fcomponents%2F_u4eQYMlKEe2iKqc0KPO99Q",
)
@register_inputs("/Playground_2/TSF-Debug")
# @register_inputs("/TSF_DEBUG/")
class ParkinEndPosSuccessKPI(TestCase):
    """Test case class"""
