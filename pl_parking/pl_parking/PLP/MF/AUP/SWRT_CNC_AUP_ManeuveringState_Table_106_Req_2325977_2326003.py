...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_106_Req_2325977_2326003"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        REAR_ULTRA = "SignalManipulation.healthVector_rearUltrasonicsUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 106 Req 2325977 2326003",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (rear ultrasonics are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_106_Req_2325977_2326003_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            rear_ultra = signals[Signals.Columns.REAR_ULTRA]
            ...
            time_threshold_2 = find_time_threshold(rear_ultra, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.REAR_ULTRA} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.REAR_ULTRA} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=rear_ultra,
                    mode="lines",
                    name=Signals.Columns.REAR_ULTRA,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_106_Req_2325977_2326003",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Init state and the Health Vector reports an AUP irreversible error \
            (rear ultrasonics are unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_106_Req_2325977_2326003_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_106_Req_2325977_2326003_TS
