...
ALIAS = "SWRT_CNC_AUP_ManeuveringState_Table_134_Req_2325987_2711725_2325993"
...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        TIME = "TimeStamp"
        ODO_ERROR = "SignalManipulation.healthVector_odometryUnreliable"
...
@teststep_definition(
    step_number=1,
    name="Maneuvering State Table 134 Req 2325987 2711725 2325993",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the odometry is unreliable) then the Automated Parking Core shall transition to Error state."
    ),
    expected_result=BooleanResult(TRUE),
)
@register_signals(ALIAS, Signals)
class SWRT_CNC_AUP_ManeuveringState_Table_134_Req_2325987_2711725_2325993_TS(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            odo_error = signals[Signals.Columns.ODO_ERROR]
            ...
            time_threshold_2 = find_time_threshold(odo_error, 1)
            ...
            if time_threshold_2 is not None:
                evaluation_1 = " ".join(
                    ...
                    f"signal {Signals.Columns.ODO_ERROR} == 1:<br>"
                ...
                evaluation_1 = " ".join(
                    f"Evaluation not possible, the trigger {Signals.Columns.ODO_ERROR} == 1 was never found.".split()
                )
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    y=odo_error,
                    mode="lines",
                    name=Signals.Columns.ODO_ERROR,
...
@testcase_definition(
    name="SWRT_CNC_AUP_ManeuveringState_Table_134_Req_2325987_2711725_2325993",
    description=(
        "This test case verifies that in case the Automated Parking Core is in Pause state and the Health Vector reports an AUP irreversible error \
            (the odometry is unreliable) then the Automated Parking Core shall transition to Error state."
    ),
...
class SWRT_CNC_AUP_ManeuveringState_Table_134_Req_2325987_2711725_2325993_TC(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            SWRT_CNC_AUP_ManeuveringState_Table_134_Req_2325987_2711725_2325993_TS
    ...
    <table>
        <tr>
            <td>
                ...
                T2: <br>
                    <em>SignalManipulation.healthVector_odometryUnreliable</em> == 1<br><br>
            </td>
        </tr>
        <tr>
            <td>
