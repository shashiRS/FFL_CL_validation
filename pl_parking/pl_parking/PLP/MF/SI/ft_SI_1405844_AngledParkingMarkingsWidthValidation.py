...
Given two angled parking markings that are separated by a free space that is:
    ...
    1. Wide enough to fit an angled parking space  (larger or equal to):

        ( {AP_V_WIDTH_M} + {AP_G_PERP_SLOT_MIN_OFFSET_W_M})

    2. Not wider than the maximum width for an angled parking space  (smaller or equal to):
...
then an angled parking box shall be defined covering the entire width of the free space
...
READER_NAME = "SI_AngledParkingMarkingsWidthValidation"
signals_obj = SISignals()


@teststep_definition(
    name="Check for SI_AngledParkingMarkingsWidthValidation",
    description="Given two angled parking markings that are separated by a free space that is "
    "Wide enough to fit an angled parking space.",
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
)
@register_signals(READER_NAME, SISignals)
class SI_AngledParkingMarkingsWidthValidation(TestStep):
    """Example test step."""
...
@verifies("ReqId_1405844")
@testcase_definition(
    name="SI_AngledParkingMarkingsWidthValidationTC",
    description="Given two angled parking markings that are separated by a free space that is "
    "Wide enough to fit an angled parking space",
    doors_url=r"https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Fresources%2FBI_9twSjDpwEe6GONELpfdJ2Q&componentURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Frm-projects%2F_D9K28PvtEeqIqKySVwTVNQ%2Fcomponents%2F_N-ji4CuIEe6mrdm2_agUYg&vvc.configuration=https%3A%2F%2Fjazz.conti.de%2Frm4%2Fcm%2Fstream%2F_G3kr8DgnEe6mrdm2_agUYg",
)
@register_inputs("/Playground_2/TSF-Debug")
class SI_AngledParkingMarkingsWidthValidationTC(TestCase):
    """Example test case."""
    ...
    def test_steps(self):
        ...
        return [
            SI_AngledParkingMarkingsWidthValidation,
        ]
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SI_AngledParkingMarkingsWidthValidationTC,
        test_bsigs,
        temp_dir=temp_dir,
