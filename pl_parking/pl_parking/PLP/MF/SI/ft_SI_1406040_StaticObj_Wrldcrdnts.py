...
@teststep_definition(
    step_number=1,
    name="StaticObjectDistanceSortingWorldCoordinatesTC",
...
class StaticObjectDistanceTypeSorting(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            number_of_StaticObjects = read_data["envModelPort.numberOfStaticObjects_u8"]
            ...
            for timestamp in filteredTimestamp:
                ...
                for vertex in range(16):
                    obj_0_x_col = f"envModelPort.staticObjects_0.objShape_m_{vertex}.x"
                    obj_0_y_col = f"envModelPort.staticObjects_0.objShape_m_{vertex}.y"
                    obj_1_x_col = f"envModelPort.staticObjects_1.objShape_m_{vertex}.x"
                    obj_1_y_col = f"envModelPort.staticObjects_1.objShape_m_{vertex}.y"
                    obj_2_x_col = f"envModelPort.staticObjects_2.objShape_m_{vertex}.x"
                    obj_2_y_col = f"envModelPort.staticObjects_2.objShape_m_{vertex}.y"
                    obj_3_x_col = f"envModelPort.staticObjects_3.objShape_m_{vertex}.x"
                    obj_3_y_col = f"envModelPort.staticObjects_3.objShape_m_{vertex}.y"
...
@verifies("ReqId_1406040")
@testcase_definition(
    name="StaticObjectDistanceSortingWorldCoordinatesTC",
    description="Test Case for static object distance sorting.",
    doors_url=r"https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Fresources%2FBI_9tz86zpwEe6GONELpfdJ2Q&componentURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Frm-projects%2F_D9K28PvtEeqIqKySVwTVNQ%2Fcomponents%2F_N-ji4CuIEe6mrdm2_agUYg&oslc.configuration=https%3A%2F%2Fjazz.conti.de%2Fgc%2Fconfiguration%2F36325",
)
...
def main(data_folder, temp_dir=None, open_explorer=True):
    ...
    test_bsigs = r"D:\Parking_SI\ergs\SI_1406040_StaticObj_WrldCrdnts\SISim_UC_Rear_Static_Obstacles.testrun.erg"
