...
READER_NAME = "SI_AngledParkingBoxOpening"
signals_obj = SISignals()


@teststep_definition(
    name="Check for SI_AngledParkingBoxOpening",
    description="The SceneInterpretation shall provide an angular parking box that has a minimum opening.",
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
)
@register_signals(READER_NAME, SISignals)
class SI_AngledParkingBoxOpening(TestStep):
    """Example test step."""
...
@verifies("ReqId_1405924")
@testcase_definition(
    name="SI_AngledParkingBoxOpeningTC",
    description="The SceneInterpretation shall provide an angular parking box that has a minimum opening.",
...
class SI_AngledParkingBoxOpeningTC(TestCase):
    """Example test case."""
