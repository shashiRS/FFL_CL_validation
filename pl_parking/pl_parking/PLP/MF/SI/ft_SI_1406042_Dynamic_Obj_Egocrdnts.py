...
@teststep_definition(
    step_number=1,
    name="DynamicObjectDistanceSortingEgoCoordinatesTC",
...
class DynamicObjectDistanceTypeSorting(TestStep):
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            number_of_DynamicObjects = read_data["collEnvModelPort.numberOfDynamicObjects_u8"]
            ...
            for timestamp in filteredTimestamp:
                ...
                for vertex in range(4):
                    obj_0_x_col = f"collEnvModelPort.dynamicObjects_0.objShape_m_{vertex}.x"
                    obj_0_y_col = f"collEnvModelPort.dynamicObjects_0.objShape_m_{vertex}.y"
                    obj_1_x_col = f"collEnvModelPort.dynamicObjects_1.objShape_m_{vertex}.x"
                    obj_1_y_col = f"collEnvModelPort.dynamicObjects_1.objShape_m_{vertex}.y"
                    obj_2_x_col = f"collEnvModelPort.dynamicObjects_2.objShape_m_{vertex}.x"
                    obj_2_y_col = f"collEnvModelPort.dynamicObjects_2.objShape_m_{vertex}.y"
                    obj_3_x_col = f"collEnvModelPort.dynamicObjects_3.objShape_m_{vertex}.x"
                    obj_3_y_col = f"collEnvModelPort.dynamicObjects_3.objShape_m_{vertex}.y"
...
@verifies("ReqId_1406042")
@testcase_definition(
    name="DynamicObjectDistanceSortingEgoCoordinatesTC",
    description="Test Case for dynamic object distance sorting.",
    doors_url=r"https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Fresources%2FBI_9tz87zpwEe6GONELpfdJ2Q&componentURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Frm-projects%2F_D9K28PvtEeqIqKySVwTVNQ%2Fcomponents%2F_N-ji4CuIEe6mrdm2_agUYg&oslc.configuration=https%3A%2F%2Fjazz.conti.de%2Fgc%2Fconfiguration%2F36325",
)
