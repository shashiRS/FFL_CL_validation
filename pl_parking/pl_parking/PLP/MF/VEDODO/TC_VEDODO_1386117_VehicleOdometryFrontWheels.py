#!/usr/bin/env python3
"""The ESC Odometry shall be applicable for front wheel driven vehicles."""
...
READER_NAME = "VedodoVelocityOdometerFrontWheels"
...
@teststep_definition(
    step_number=1,
    name="The ESC Odometry shall be applicable for front wheel driven vehicles",
    description="The ESC Odometry shall be applicable for front wheel driven vehicles",
    expected_result=BooleanResult(TRUE),
)
@register_signals(READER_NAME, VedodoSignals)
class VedodoVehicleOdometryForFrontWheels(TestStep):
    """The ESC Odometry shall be applicable for front wheel driven vehicles
...
@verifies("ReqID_1386117")
@testcase_definition(
    name="The ESC Odometry shall be applicable for front wheel driven vehicles.",
    description="The ESC Odometry shall be applicable for front wheel driven vehicles.",
    doors_url="https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A%2F"
    "%2Fjazz.conti.de%2Frm4%2Fresources%2FBI_3z6cjjaaEe6mrdm2_agUYg&componentURI=https%3A%2F%2Fjazz.cont"
...
class VedodoVehicleOdometryForFrontWheelsTestCase(TestCase):
    """Example test case."""
    ...
    def test_steps(self):
        ...
        return [
            VedodoVehicleOdometryForFrontWheels,
        ]
...
def main(temp_dir: Path = None, open_explorer=True):
    ...
    _, testrun_id, cp = debug(
        VedodoVehicleOdometryForFrontWheelsTestCase,
        temp_dir=temp_dir,
