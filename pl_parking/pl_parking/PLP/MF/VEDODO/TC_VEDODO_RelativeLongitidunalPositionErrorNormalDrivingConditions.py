#!/usr/bin/env python3
"""This is the test case to validate the relative Longitudinal position error during normal driving conditions"""
...
READER_NAME = "VedodoRelativeLongitudinalPositionErrorInNormalDrivingConditions"
...
class VedodoRelativeLongitudinalPositionErrorNormalDrivingConditions(TestStep):
    ...
    def process(self, **kwargs):
        ...
        fig.add_trace(
            go.Scatter(
                ...
                * len(ap_time),
                mode="lines",
                name="Longitudinal position error threshold",
            )
        )
        ...
        # Longitudinal position error of GT vs Estimate
        fig = go.Figure()
        fig.add_trace(
            go.Scatter(
                x=ap_time,
        ...
        fig.add_annotation(
            dict(
                ...
                y=-0.12,
                showarrow=False,
                text="Longitudinal GT vs Estimate",
                textangle=0,
                xanchor="left",
                xref="paper",
                yref="paper",
        ...
        additional_results_dict = {
            ...
            "Driven Distance": {"value": max_longi_error, "color": get_color(test_result)},
        }
...
class VedodoRelativeLongitudinalPositionErrorNormalDrivingConditionsTestCase(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            VedodoRelativeLongitudinalPositionErrorNormalDrivingConditions,
        ]
...
def main(temp_dir: Path = None, open_explorer=True):
    ...
    _, testrun_id, cp = debug(
        VedodoRelativeLongitudinalPositionErrorNormalDrivingConditionsTestCase,
        temp_dir=temp_dir,
