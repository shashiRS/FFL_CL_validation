#!/usr/bin/env python3
"""
When there is a pressure difference at one or more wheels of not more than 0.5 bar from the specified inflation
pressure, the ESC Odometry shall achieve the precision
"""
...
READER_NAME = "VedodoVelocityOdometerWithDifferentTirePressure"
...
@teststep_definition(
    step_number=1,
    name="When there is a pressure difference at one or more wheels of not more than 0.5 bar from the specified "
    "inflation pressure, the ESC Odometry shall achieve the precision",
    description="When there is a pressure difference at one or more wheels of not more than 0.5 bar from the "
    "specified inflation pressure, the ESC Odometry shall achieve the precision",
    expected_result=BooleanResult(TRUE),
)
@register_signals(READER_NAME, VedodoSignals)
class VedodoVehicleOdometryWithDifferentTirePressure(TestStep):
    """When there is a pressure difference at one or more wheels of not more than 0.5 bar from the specified
    inflation pressure, the ESC Odometry shall achieve the precision
...
@testcase_definition(
    ...
    "2F%2Fjazz.conti.de%2Frm4%2Fresources%2FBI_3z7DijaaEe6mrdm2_agUYg&componentURI=https%3A%2F%2Fjazz."
    "conti.de%2Frm4%2Frm-projects%2F_D9K28PvtEeqIqKySVwTVNQ%2Fcomponents%2F_2ewE0DK_Ee6mrdm2_agUYg&osl"
    "c.configuration=https%3A%2F%2Fjazz.conti.de%2Fgc%2Fconfiguration%2F30013",
)
