...
Calculating the deviate YawRate Limit with given time or frequency and with Differential Wheel Model
"""
...
READER_NAME = "VedodoYawRateWithDifferentialWheelModel"
...
class VedodoYawRateWithDifferentialWheelModel(TestStep):
    """Test case for Vedodo YawRate with Differential Wheel Model.
    ...
    def process(self, **kwargs):
        ...
        if max_yawrate_deviate < max_expected_deviate_yawrate:
            evaluation = " ".join(
                ...
                f"{round(max_yawrate_deviate, 3)}rad/s and the expected threshold is {max_expected_deviate_yawrate} "
...
@verifies("ReqID_1790824")
@testcase_definition(
    name="YawRate test case Differential Wheel Model",
    description="VEDODO TestCase YawRate with Differential Wheel Model",
    doors_url="https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A"
    "%2F%2Fjazz.conti.de%2Frm4%2Fresources%2FBI_Y8qC4AkpEe-9Pf5VGwDpVA&componentURI=https%3A%2F%2Fjaz"
    "z.conti.de%2Frm4%2Frm-projects%2F_D9K28PvtEeqIqKySVwTVNQ%2Fcomponents%2F_2ewE0DK_Ee6mrdm2_agUYg&"
    "oslc.configuration=https%3A%2F%2Fjazz.conti.de%2Fgc%2Fconfiguration%2F30013",
)
@register_inputs("/parking")
# @register_inputs("/TSF_DEBUG/")
class WithDifferentialWheelModelTestCase(TestCase):
    """Example test case."""
    ...
    def test_steps(self):
        ...
        return [
            VedodoYawRateWithDifferentialWheelModel,
        ]
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    _, testrun_id, cp = debug(
        WithDifferentialWheelModelTestCase,
        temp_dir=temp_dir,
