#!/usr/bin/env python3
"""This is the test case to check the longitudinal velocity"""
...
READER_NAME = "VedodoVelocityOdometryLongitudinalVelocity"
...
@teststep_definition(
    step_number=1,
    name="The ESC Odometry shall provide the longitudinal velocity.",
    description="The ESC Odometry shall provide the longitudinal velocity.",
    expected_result=BooleanResult(TRUE),
)
@register_signals(READER_NAME, VedodoSignals)
class VedodoVehicleEstimatedLongitudinalVelocity(TestStep):
...
@verifies("ReqID_1386023")
@testcase_definition(
    name="The ESC Odometry shall provide the longitudinal velocity.",
    description="The ESC Odometry shall provide the longitudinal velocity.",
    doors_url="https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A%2F%2Fj"
    "azz.conti.de%2Frm4%2Fresources%2FBI_3z4nXjaaEe6mrdm2_agUYg&oslc_config.context=https%3A%2F%2Fjazz.conti"
...
class VedodoVehicleEstimatedLongitudinalVelocityTestCase(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            VedodoVehicleEstimatedLongitudinalVelocity,
        ]
