#!/usr/bin/env python3
"""This is the test case to provide the front steer wheels angle"""
...
READER_NAME = "VedodoVelocityOdometerFrontSteerWheelsAngle"
...
@teststep_definition(
    step_number=1,
    name="The ESC Odometry shall provide the front steer wheels angle.",
    description="The ESC Odometry shall provide the front steer wheels angle.",
    expected_result=BooleanResult(TRUE),
)
@register_signals(READER_NAME, VedodoSignals)
class VedodoOdometryFrontSteerWheelsAngle(TestStep):
    """The ESC Odometry shall provide the front steer wheels angle.
    ...
    def process(self, **kwargs):
        ...
        signal_summary["Estimated Front Steer Wheels Angle"] = evaluation
...
@verifies("ReqID_1386042")
@testcase_definition(
    name="The ESC Odometry shall provide the front steer wheels angle.",
    description="The ESC Odometry shall provide the front steer wheels angle.",
    doors_url="https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A%2F%2F"
    "jazz.conti.de%2Frm4%2Fresources%2FBI_3z5OXzaaEe6mrdm2_agUYg&oslc_config.context=https%3A%2F%2Fjazz.co"
    "nti.de%2Fgc%2Fconfiguration%2F17099&componentURI=https%3A%2F%2Fjazz.conti.de%2Frm4%2Frm-projects%2F_D"
    "9K28PvtEeqIqKySVwTVNQ%2Fcomponents%2F_2ewE0DK_Ee6mrdm2_agUYg",
)
@register_inputs("/parking")
# @register_inputs("/TSF_DEBUG/")
class VedodoOdometryFrontSteerWheelsAngleTestCase(TestCase):
    """Example test case."""
    ...
    def test_steps(self):
        ...
        return [
            VedodoOdometryFrontSteerWheelsAngle,
        ]
...
def main(temp_dir: Path = None, open_explorer=True):
    ...
    _, testrun_id, cp = debug(
        VedodoOdometryFrontSteerWheelsAngleTestCase,
        temp_dir=temp_dir,
