...
class Parking:  # noqa: D101
    ...
    def get_base_string(reader: Any, platform: str) -> Union[None, str]:
        ...
        if platform == Platforms.SIM:
            if "AP.headUnitVisualizationPort.screen_nu" or "AP.evaluationPort.useCase_nu" in reader.signals:
                basestring = "AP."
        ...
        if platform == Platforms.VEHICLE:
            basestring = []
            if "MTS.Package.TimeStamp" in reader.signals:
                basestring.append("MTS.Package.")
            if "M7board.EM_Thread.PSMDebugPort.stateVarPPC_nu" in reader.signals:
                basestring.append("M7board.EM_Thread.")
            if "Reference_CAN.RT-Range_2017_02_28_SystemC.RangeHunterPosLocal.RangeHunterPosLocalX" in reader.signals:
                basestring.append("Reference_CAN.RT-Range_2017_02_28_SystemC.")
            if "Reference_CAN.NAVconfig_AP_Passat_154_28-02-2017.HeadingPitchRoll.AngleHeading" in reader.signals:
                basestring.append("Reference_CAN.NAVconfig_AP_Passat_154_28-02-2017.")
            if "M7board.CAN_Thread.OdoEstimationPort.yPosition_m" in reader.signals:
    ...
    @staticmethod
    # @typechecked
    def data_mapping(base_string):  # noqa: D102
        return {
...
class ExampleSignals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        SCENEINTERPRETATION = "sceneInterpretationActive_nu"
        FURTHESTOBJ_YAW = "furthestObject_yaw"
        FURTHESTOBJ_SROAD = "furthestObject_sRoad"
    ...
    def __init__(self):
        ...
        self._properties = {
            ...
            self.Columns.STEERINGWHEELANGLEVELOCITY_RADPS: (
                ".odoInputPort.odoSigFcanPort.steerCtrlStatus.steeringWheelAngleVelocity_radps"
            ),
            self.Columns.LATERALACCELERATION_MPS2: ".odoInputPort.odoSigFcanPort.vehDynamics.lateralAcceleration_mps2",
            self.Columns.LONGITUDINALACCELERATION_MPS2: (
                ".odoInputPort.odoSigFcanPort.vehDynamics.longitudinalAcceleration_mps2"
            ),
            ...
            self.Columns.SCENEINTERPRETATION: ".sceneInterpretationActive_nu",
            self.Columns.FURTHESTOBJ_SROAD: ".trafficObject.furthestObject.sRoad",
            self.Columns.FURTHESTOBJ_YAW: ".trafficObject.furthestObject.yaw",
            self.Columns.PARKINGBOX0_SLOTCOORDINATES0_X: (
                ".parkingBoxPortCMOrigin.parkingBoxes_0.slotCoordinates_FrontLeft_x"
            ),
            self.Columns.PARKINGBOX0_SLOTCOORDINATES0_Y: (
                ".parkingBoxPortCMOrigin.parkingBoxes_0.slotCoordinates_FrontLeft_y"
            ),
            self.Columns.PARKINGBOX0_SLOTCOORDINATES1_X: (
                ".parkingBoxPortCMOrigin.parkingBoxes_0.slotCoordinates_RearLeft_x"
            ),
            self.Columns.PARKINGBOX0_SLOTCOORDINATES1_Y: (
                ".parkingBoxPortCMOrigin.parkingBoxes_0.slotCoordinates_RearLeft_y"
            ),
            self.Columns.PARKINGBOX0_SLOTCOORDINATES2_X: (
                ".parkingBoxPortCMOrigin.parkingBoxes_0.slotCoordinates_RearRight_x"
            ),
            self.Columns.PARKINGBOX0_SLOTCOORDINATES2_Y: (
                ".parkingBoxPortCMOrigin.parkingBoxes_0.slotCoordinates_RearRight_y"
            ),
            self.Columns.PARKINGBOX0_SLOTCOORDINATES3_X: (
                ".parkingBoxPortCMOrigin.parkingBoxes_0.slotCoordinates_FrontRight_x"
            ),
            self.Columns.PARKINGBOX0_SLOTCOORDINATES3_Y: (
                ".parkingBoxPortCMOrigin.parkingBoxes_0.slotCoordinates_FrontRight_y"
            ),
            self.Columns.PARKINGBOX1_SLOTCOORDINATES0_X: (
                ".parkingBoxPortCMOrigin.parkingBoxes_1.slotCoordinates_FrontLeft_x"
            ),
            self.Columns.PARKINGBOX1_SLOTCOORDINATES0_Y: (
                ".parkingBoxPortCMOrigin.parkingBoxes_1.slotCoordinates_FrontLeft_y"
            ),
            self.Columns.PARKINGBOX1_SLOTCOORDINATES1_X: (
                ".parkingBoxPortCMOrigin.parkingBoxes_1.slotCoordinates_RearLeft_x"
            ),
            self.Columns.PARKINGBOX1_SLOTCOORDINATES1_Y: (
                ".parkingBoxPortCMOrigin.parkingBoxes_1.slotCoordinates_RearLeft_y"
            ),
            self.Columns.PARKINGBOX1_SLOTCOORDINATES2_X: (
                ".parkingBoxPortCMOrigin.parkingBoxes_1.slotCoordinates_RearRight_x"
            ),
            self.Columns.PARKINGBOX1_SLOTCOORDINATES2_Y: (
                ".parkingBoxPortCMOrigin.parkingBoxes_1.slotCoordinates_RearRight_y"
            ),
            self.Columns.PARKINGBOX1_SLOTCOORDINATES3_X: (
                ".parkingBoxPortCMOrigin.parkingBoxes_1.slotCoordinates_FrontRight_x"
            ),
            self.Columns.PARKINGBOX1_SLOTCOORDINATES3_Y: (
                ".parkingBoxPortCMOrigin.parkingBoxes_1.slotCoordinates_FrontRight_y"
            ),
        }
