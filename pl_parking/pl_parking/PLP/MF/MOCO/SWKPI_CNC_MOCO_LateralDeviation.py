...
ALIAS = "SWKPI_CNC_MOCO_LateralDeviation"
        ...
        try:
            ...
            if not df_filtered.empty:
                ...
                for _, car_pos_row in df_filtered.iterrows():
                    ...
                    elif abs(current_deviation_from_path) <= constants.MoCo.Parameter.AP_C_KPI_PASS_MAX_LAT_ERROR_M:
                        "Passed Criteria"
...
@tag("SWKPI_CNC_MOCO_LateralDeviation")
@verifies("1735577")
@testcase_definition(
...
class SWKPI_CNC_MOCO_LateralDeviation(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWKPI_CNC_MOCO_LateralDeviation,
        *test_bsigs,
        temp_dir=temp_dir,
