...
ALIAS = "SWRT_CNC_MOCO_LateralActiveControl"
...
@tag("SWRT_CNC_MOCO_LateralActiveControl")
@verifies("1406994")
@testcase_definition(
...
class SWRT_CNC_MOCO_LateralActiveControl(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_LateralActiveControl,
        *test_bsigs,
        temp_dir=temp_dir,
