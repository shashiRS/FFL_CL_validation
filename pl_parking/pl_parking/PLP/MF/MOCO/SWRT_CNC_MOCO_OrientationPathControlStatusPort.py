...
ALIAS = "SWRT_CNC_MOCO_OrientationPathControlStatusPort"
...
@tag("SWRT_CNC_MOCO_OrientationPathControlStatusPort")
@verifies("1407026")
@testcase_definition(
...
class SWRT_CNC_MOCO_OrientationPathControlStatusPort(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_OrientationPathControlStatusPort,
        *test_bsigs,
        temp_dir=temp_dir,
