...
ALIAS = "SWKPI_CNC_MOCO_MaximumStandstillTime"
...
@tag("SWKPI_CNC_MOCO_MaximumStandstillTime")
@verifies("1735594")
@testcase_definition(
...
class SWKPI_CNC_MOCO_MaximumStandstillTime(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWKPI_CNC_MOCO_MaximumStandstillTime,
        *test_bsigs,
        temp_dir=temp_dir,
