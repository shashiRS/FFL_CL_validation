...
ALIAS = "SWRT_CNC_MOCO_LateralInactiveControl"
...
@tag("SWRT_CNC_MOCO_LateralInactiveControl")
@verifies("1406995")
@testcase_definition(
...
class SWRT_CNC_MOCO_LateralInactiveControl(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_LateralInactiveControl,
        *test_bsigs,
        temp_dir=temp_dir,
