...
ALIAS = "SWRT_CNC_MOCO_LongitudinalActiveControl"
...
@tag("SWRT_CNC_MOCO_LongitudinalActiveControl")
@verifies("1407042")
@testcase_definition(
...
class SWRT_CNC_MOCO_LongitudinalActiveControl(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_LongitudinalActiveControl,
        *test_bsigs,
        temp_dir=temp_dir,
