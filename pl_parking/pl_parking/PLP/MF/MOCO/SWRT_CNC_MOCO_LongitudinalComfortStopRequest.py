...
ALIAS = "SWRT_CNC_MOCO_LongitudinalComfortStopRequest"
...
@tag("SWRT_CNC_MOCO_LongitudinalComfortStopRequest")
@verifies("1407048")
@testcase_definition(
...
class SWRT_CNC_MOCO_LongitudinalComfortStopRequest(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_LongitudinalComfortStopRequest,
        *test_bsigs,
        temp_dir=temp_dir,
