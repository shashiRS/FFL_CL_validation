...
ALIAS = "SWKPI_CNC_MOCO_OrientationDeviation"
        ...
        try:
            ...
            if not df_filtered.empty:
                ...
                for _, car_pos_row in df_filtered.iterrows():
                    ...
                    elif abs(orientationError_deg) <= constants.MoCo.Parameter.AP_C_KPI_PASS_MAX_YAW_ERROR_DEG:
                        "Passed Criteria"
                ...
                if assertion_dict:
                    ...
                    eval_text = " ".join(
                        f"Absolute Orientation deviation from path is less than"
                        f"AP_C_KPI_FAIL_MAX_YAW_ERROR_DEG({constants.MoCo.Parameter.AP_C_KPI_FAIL_MAX_YAW_ERROR_DEG})"
                        f"and within pass and acceptable criteria."
                        f"Conditions: {test_result}.".split()
                    )
...
@tag("SWKPI_CNC_MOCO_OrientationDeviation")
@verifies("1735265")
@testcase_definition(
...
class SWKPI_CNC_MOCO_OrientationDeviation(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWKPI_CNC_MOCO_OrientationDeviation,
        *test_bsigs,
        temp_dir=temp_dir,
