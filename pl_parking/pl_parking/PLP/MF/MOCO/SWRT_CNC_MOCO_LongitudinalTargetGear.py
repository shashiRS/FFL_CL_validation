...
ALIAS = "SWRT_CNC_MOCO_LongitudinalTargetGear"
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            if check_target_gear(df_filtered) and not df_filtered.empty:
                ...
                eval_text = "Appliead gear is equal to the target gear"
                self.result.measured_result = NAN
...
@tag("SWRT_CNC_MOCO_LongitudinalTargetGear")
@verifies("1407045")
@testcase_definition(
...
class SWRT_CNC_MOCO_LongitudinalTargetGear(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_LongitudinalTargetGear,
        *test_bsigs,
        temp_dir=temp_dir,
