...
ALIAS = "SWRT_CNC_MOCO_LongitudinalActiveGearBoxControl"
...
@tag("SWRT_CNC_MOCO_LongitudinalActiveGearBoxControl")
@verifies("1407043")
@testcase_definition(
...
class SWRT_CNC_MOCO_LongitudinalActiveGearBoxControl(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_LongitudinalActiveGearBoxControl,
        *test_bsigs,
        temp_dir=temp_dir,
