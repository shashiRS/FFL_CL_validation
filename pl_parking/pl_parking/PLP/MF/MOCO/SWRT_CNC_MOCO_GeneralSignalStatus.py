...
ALIAS = "SWRT_CNC_MOCO_GeneralSignalStatus"
...
@tag("SWRT_CNC_MOCO_GeneralSignalStatus")
@verifies("1665879")
@testcase_definition(
...
class SWRT_CNC_MOCO_GeneralSignalStatus(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_GeneralSignalStatus,
        *test_bsigs,
        temp_dir=temp_dir,
