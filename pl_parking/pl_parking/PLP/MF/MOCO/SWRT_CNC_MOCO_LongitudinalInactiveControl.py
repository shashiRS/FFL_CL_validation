...
ALIAS = "SWRT_CNC_MOCO_LongitudinalInactiveControl"
        ...
        try:
            ...
            if (df["activateLoCtrl"] == 0).any():
                ...
                if percent_match == 100:
                    ...
                    test_result = fc.FAIL
                    eval_text = " ".join(
                        f" There is no 100% signal match."
                        f" Conditions: {test_result}.".split()
                    )
...
@tag("SWRT_CNC_MOCO_LongitudinalInactiveControl")
@verifies("1407047")
@testcase_definition(
...
class SWRT_CNC_MOCO_LongitudinalInactiveControl(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MOCO_LongitudinalInactiveControl,
        *test_bsigs,
        temp_dir=temp_dir,
