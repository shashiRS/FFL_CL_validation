...
def evaluation_result(result, tyre, threshold, deviation):
    ...
    if not result:
        ...
        evaluation = (
            f"Evaluation of Tire Circumference for the {tyre} non-driven axle wheel deviated {deviation}m and the"
...
class TceTyreCircumferenceForNonDrivenAxleWheels(TestStep):
    ...
    def process(self, **kwargs):
        ...
        fl_test_result, fl_evaluation = evaluation_result(
            fl_result, "rear left", max_deviation_threshold, fl_max_deviation
        )
        ...
        fr_test_result, fr_evaluation = evaluation_result(
            fr_result, "rear right", max_deviation_threshold, fr_max_deviation
        )
