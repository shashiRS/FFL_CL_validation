#!/usr/bin/env python3
"""This is the test case to check the TCE provide the Estimated  Tire Circumference for the driven axle wheels,
ie In a Typical Front axle Driven vehicle front axle right wheel, front axle left wheel
"""
...
READER_NAME = "TceTyreCircumferenceForDrivenFrontAxleWheels"
...
def check_tyre_circumference_for_driven_wheels(gt_tyre, algo_tyre, driven_distance):
...
@teststep_definition(
    step_number=1,
    name="The TCE shall provide the Tire Circumference for the driven axle wheels.",
    description="The TCE provide the Estimated  Tire Circumference for the driven axle wheels, "
    "ie In a Typical Front axle Driven vehicle front axle right wheel, front axle left wheel.",
    expected_result=BooleanResult(TRUE),
)
@register_signals(READER_NAME, TceSignals)
class TceTyreCircumferenceForDrivenAxleWheels(TestStep):
    """Test case for TCE Tire Circumference for the driven axle wheels.

    Objective
    ---------

    The TCE shall provide the Tire Circumference for the driven axle wheels.
    ...
    def process(self, **kwargs):
        ...
        fl_tyre_error_list = check_tyre_circumference_for_driven_wheels(gt_tire_front, est_tire_fl, driven_distance)
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=est_tire_fl,
                mode="lines",
                name=CarMakerUrl.estTyreCircFL,
            )
        )
        fig.add_trace(
            go.Scatter(
                ...
                * len(ap_time),
                mode="lines",
                name="Ground Truth Front Left Tyre Circumference",
            )
        )
        ...
        fig.add_annotation(
            dict(
                ...
                y=-0.12,
                showarrow=False,
                text="Estimated VS GT Front Left Tyre Circumference",
                textangle=0,
                xanchor="left",
                xref="paper",
                yref="paper",
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=est_tire_fr,
                mode="lines",
                name=CarMakerUrl.estTyreCircFR,
            )
        )
        fig.add_trace(
            go.Scatter(
                ...
                * len(ap_time),
                mode="lines",
                name="Ground Truth Front Right Tyre Circumference",
            )
        )
        fig.layout = go.Layout(
            yaxis=dict(tickformat="14"), xaxis=dict(tickformat="14"), xaxis_title="Time[s]", yaxis_title="Distance[m]"
        ...
        fig.add_annotation(
            dict(
                ...
                y=-0.12,
                showarrow=False,
                text="Estimated VS GT Front Right Tyre Circumference",
                textangle=0,
                xanchor="left",
                xref="paper",
                yref="paper",
        ...
        fig.add_annotation(
            dict(
                ...
                y=-0.12,
                showarrow=False,
                text="Front left tyre circumference error VS Threshold",
                textangle=0,
                xanchor="left",
                xref="paper",
                yref="paper",
        ...
        fig.add_annotation(
            dict(
                ...
                y=-0.12,
                showarrow=False,
                text="Front right tyre circumference error VS Threshold",
                textangle=0,
                xanchor="left",
                xref="paper",
                yref="paper",
        ...
        additional_results_dict = {
            ...
            fc.REQ_ID: ["1675931"],
            fc.TESTCASE_ID: ["41447"],
            fc.TEST_RESULT: [test_result],
        }
        self.result.details["Additional_results"] = additional_results_dict


@verifies("ReqID_1675931")
@testcase_definition(
    name="TCE Tire Circumference for the driven axle wheels.",
    description="TCE Tire Circumference for the driven axle wheels.",
    doors_url="https://jazz.conti.de/rm4/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI=https%3A%2F%2F"
    "jazz.conti.de%2Frm4%2Fresources%2FBI_yDU1oXpAEe6n7Ow9oWyCxw&oslc_config.context=https%3A%2F%2Fjazz.cont"
...
class TceTyreCircumferenceForDrivenAxleWheelsTestCase(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            TceTyreCircumferenceForDrivenAxleWheels,
        ]
...
def main(temp_dir: Path = None, open_explorer=True):
    ...
    _, testrun_id, cp = debug(
        TceTyreCircumferenceForDrivenAxleWheelsTestCase,
        temp_dir=temp_dir,
