"""LSCA react to static objects that are in collision path."""
...
SIGNAL_DATA = "LSCA_REACT_STATIC_OBJ_COLLISION_PATH"
...
class ValidationSignals(MDFSignalDefinition):
    ...
    class Columns(MDFSignalDefinition.Columns):
        ...
        TRAFFIC_PARTICIPANT_VEL = "TRAFFIC_PARTICIPANT_VEL"
    ...
    def __init__(self):
        ...
        self._properties = {
            ...
            self.Columns.TRAFFIC_PARTICIPANT_VEL: "CM.Traffic.T00.LongVel",
...
@teststep_definition(
    name="LSCA react to static objects in collision path",
    description="LSCA shall react to static objects on collision path within the Traffic Participant detection zone "
    "within [treaction LSCA].",
    expected_result=BooleanResult(TRUE),
)
@register_signals(SIGNAL_DATA, ValidationSignals)
class LscaReactStaticObjCollisionPath(TestStep):
    """LscaReactStaticObjCollisionPath Test Step."""
    ...
    def process(self, **kwargs):
        ...
        traffic_part_vel = signals[ValidationSignals.Columns.TRAFFIC_PARTICIPANT_VEL].tolist()
        ...
        if not trigger0:
            ...
            evaluation = " ".join(
                ...
                f"{signals_obj._properties[ValidationSignals.Columns.T0_uss4_dist]}, <br>"
                f" or traffic participant velocity signal:"
                f"{signals_obj._properties[ValidationSignals.Columns.TRAFFIC_PARTICIPANT_VEL]}"
                f"was != 0".split()
            )
        ...
        columns = [
            ...
            ValidationSignals.Columns.TRAFFIC_PARTICIPANT_VEL,
...
@verifies(
    requirement="2939518",
    doors_url="https://jazz.conti.de/rm4/resources/BI_k6AioKswEe-h96jyDYWsSA?oslc_config.context=https%3A%2F%2Fjazz.conti.de%2Fgc%2Fconfiguration%2F36324",
)
@testcase_definition(
    name="LSCA react to static objects in collision path",
    description="LSCA shall react to static objects on collision path within the Traffic Participant detection "
    "zone within [treaction LSCA].",
)
class LscaReactStaticObjCollisionPathTestCase(TestCase):
    """LscaReactStaticObjCollisionPath test case."""
    ...
    def test_steps(self):
        ...
        return [
            LscaReactStaticObjCollisionPath,
        ]
