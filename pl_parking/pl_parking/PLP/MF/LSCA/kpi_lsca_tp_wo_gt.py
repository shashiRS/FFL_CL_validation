...
@teststep_definition(
    step_number=1,
    name="TP KPI LSCA",
    description="Check TP of LSCA function without GT.",
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            if not total_brake_events:
                brake_classification = fc.NOT_ASSESSED
                eval_text = "LSCA component did not interveene (signal != 1 throughout the measurement)."
...
class LscaTruePositiveWithoutGT(TestCase):
    """Test case."""
