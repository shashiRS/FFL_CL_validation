...
@teststep_definition(
    name="Release brake check, kick down the gas pedal",
    description="If the driver releases (or already has released) and kicks down the gas pedal, the LSCA function shall release the brake after these actions are fulfilled.",
    expected_result=BooleanResult(TRUE),
)
@register_signals(SIGNAL_DATA, ValidationSignals)
class LscaKickPedalCheck(TestStep):
    """LscaKickPedal Test Step."""
    ...
    def process(self, **kwargs):
        ...
        if t1_idx is None:
            ...
            if t2_idx is None:
                ...
                if t3_idx is None:
                    ...
                    # Step 4: Find when driver kickdown gas pedal (gas pedal > 0.03)
        ...
        signal_summary["LSCA release brake request, gas pedal kicked"] = evaluation1
...
class LscaKickPedal(TestCase):
    """LscaKickPedal Test Case."""
