...
@teststep_definition(
    step_number=1,
    name="LSCA static object",
    description="Check if LSCA function detect a static object.",
    expected_result=BooleanResult(TRUE),
)
@register_signals(EXAMPLE, Signals)
class LscaStaticTestStep(TestStep):
    """Test step class"""
            ...
            if not total_brake_events:
                ...
                for timestamp_event in timestamp_brake_events:
                    ...
                    if distance_ego_object < constants.LscaConstants.SAFETY_MARGIN_CRASH:
                        ...
                        distance_ego_object
                        <= (
                            constants.LscaConstants.SAFETY_MARGIN_STATIC
