...
class PDW_deactivation_by_Pgear_standstill(TestStep):
    """Example test step"""
    ...
    def process(self, **kwargs):
        ...
        for frame in range(0, len(time_signal)):
            ...
            if not start_waiting:
                ...
                if veh_ignition[frame] and pdw_state[frame] != constants.HilCl.PDW.States.FAILURE:
                    ...
                    if pdw_deactv_by_pgear[frame] and pdw_standstill_autoact[frame]:
                        trigger2 = True
                        ...
                        if veh_velocity[frame] < abs(constants.HilCl.PDW.Thresholds.MIN_SPEED_THRESHOLD_MPS):
                            ...
                            if ObjectDetection(frame):
                                ...
                                if (
                                    ...
                                    and park_brake[frame] is not True
        ...
        if trigger1 is False:
            ...
            preconditions = "Check trigger4! No object detectected by USS."
        elif trigger5 is None:
            preconditions = f"Check trigger5! Gear not switched to NEUTRAL (automatic-{constants.HilCl.PDW.Gear.Automatic.NEUTRAL} , manual-{constants.HilCl.PDW.Gear.Manual.NEUTRAL})."
        elif trigger6 is False:
            preconditions = f"Check trigger6! PDW state not switched to 'Automatically activation' ({constants.HilCl.PDW.States.AUTOMATICALLY_ACTIVATED}) beforehand."
...
class PdwHil(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            PDW_deactivation_by_Pgear_standstill,
        ]
