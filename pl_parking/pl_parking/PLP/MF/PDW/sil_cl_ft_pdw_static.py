...
class Signals(SignalDefinition):
    ...
    class Columns(SignalDefinition.Columns):
        ...
        OBSTACE_DISTANCE = "EvalShortDist{}"
        OBSTACE_DISTANCE0 = "EvalShortDist0"
        OBSTACE_DISTANCE1 = "EvalShortDist1"
        OBSTACE_DISTANCE2 = "EvalShortDist2"
        OBSTACE_DISTANCE3 = "EvalShortDist3"
        OBSTACE_DISTANCE4 = "EvalShortDist4"
        OBSTACE_DISTANCE5 = "EvalShortDist5"
        OBSTACE_DISTANCE6 = "EvalShortDist6"
        OBSTACE_DISTANCE7 = "EvalShortDist7"
        OBSTACE_DISTANCE8 = "EvalShortDist8"
        OBSTACE_DISTANCE9 = "EvalShortDist9"
        OBSTACE_DISTANCE10 = "EvalShortDist10"
        OBSTACE_DISTANCE11 = "EvalShortDist11"
        OBSTACE_DISTANCE12 = "EvalShortDist12"
        OBSTACE_DISTANCE13 = "EvalShortDist13"
        OBSTACE_DISTANCE14 = "EvalShortDist14"
        OBSTACE_DISTANCE15 = "EvalShortDist15"
        OBSTACE_DISTANCE16 = "EvalShortDist16"
    ...
    def __init__(self):
        ...
        left_sectors_distance = {
            self.Columns.SECTOR_DISTANCELE.format(x): f"AP.pdcpSectorsPort.sectorsLeft_{x}.smallestDistance_m"
            for x in range(4)
        }
        ...
        obs_short_dist = {
            self.Columns.OBSTACE_DISTANCE.format(x + 1): f"AP.testEvaluation.shortestDistanceCM[{x+1}]"
            for x in range(16)
        }
        ...
        self._properties.update(obs_short_dist)
...
@teststep_definition(
    ...
    description=(
        "This test step evaluates PDW at initialization state and if any state changes occurs."
...
class TestStepPDW(TestStep):
    ...
    def process(self, **kwargs):
        ...
        self.short_dist_2 = signals[Signals.Columns.OBSTACE_DISTANCE2]
        self.short_dist_3 = signals[Signals.Columns.OBSTACE_DISTANCE3]
        self.short_dist_4 = signals[Signals.Columns.OBSTACE_DISTANCE4]
        self.short_dist_5 = signals[Signals.Columns.OBSTACE_DISTANCE5]
        self.short_dist_6 = signals[Signals.Columns.OBSTACE_DISTANCE6]
        self.short_dist_7 = signals[Signals.Columns.OBSTACE_DISTANCE7]
        self.short_dist_8 = signals[Signals.Columns.OBSTACE_DISTANCE8]
        self.short_dist_9 = signals[Signals.Columns.OBSTACE_DISTANCE9]
        self.short_dist_10 = signals[Signals.Columns.OBSTACE_DISTANCE10]
        self.short_dist_11 = signals[Signals.Columns.OBSTACE_DISTANCE11]
        self.short_dist_12 = signals[Signals.Columns.OBSTACE_DISTANCE12]
        self.short_dist_13 = signals[Signals.Columns.OBSTACE_DISTANCE13]
        self.short_dist_14 = signals[Signals.Columns.OBSTACE_DISTANCE14]
        self.short_dist_15 = signals[Signals.Columns.OBSTACE_DISTANCE15]
        self.short_dist_16 = signals[Signals.Columns.OBSTACE_DISTANCE16]
...
@teststep_definition(
    ...
    description=(
        "This test step evaluates the left sector signals for PDW function when a staic obstacle is present iside the sector."
    ),  # this would be shown as a test step description in html report
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
...
@register_signals(ALIAS, Signals)
class TestStepPDWLeft(TestStepPDW):
    """testcase that can be tested by a simple pass/fail test.
    This is a required docstring in which you can add more details about what you verify in test step
    ...
    def process(self, **kwargs):
        ...
        obj_signal = [
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE13],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE14],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE15],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE16],
        ]

        signal_summary, verdict = pdwh.all_sector_evaluation(
            smallest_dist_le, smallest_crit_le, left_dist_signal, short_dist, obj_signal
        )
        ...
        fig = go.Figure()
        # add the needed signals in the plot
        # fig = self.sectors_plot(smallest_dist_le,smallest_crit_le)
        for i in range(4):
            fig.add_trace(
                go.Scatter(
                    x=ap_time,
                    y=smallest_dist_le[i],
                    mode="lines",
...
@teststep_definition(
    ...
    description=(
        "This test step evaluates the rear sector signals for PDW function when a static obstacle is present iside the sector."
    ),  # this would be shown as a test step description in html report
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
...
@register_signals(ALIAS, Signals)
class TestStepPDWRear(TestStepPDW):
    """testcase that can be tested by a simple pass/fail test.
    This is a required docstring in which you can add more details about what you verify in test step
    ...
    def process(self, **kwargs):
        ...
        obj_signal = [
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE9],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE10],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE11],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE12],
        ]
        signal_summary, verdict = pdwh.all_sector_evaluation(
            smallest_dist_re, smallest_crit_re, rear_dist_signal, short_dist, obj_signal
        )
...
@teststep_definition(
    step_number=4,
    name="Front sector",  # this would be shown as a test step name in html report
    description=(
        "This test step evaluates the front sector signals for PDW function when a static obstacle is present iside the sector."
    ),  # this would be shown as a test step description in html report
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
...
@register_signals(ALIAS, Signals)
class TestStepPDWFront(TestStepPDW):
    """testcase that can be tested by a simple pass/fail test.
    This is a required docstring in which you can add more details about what you verify in test step
    ...
    def process(self, **kwargs):
        ...
        obj_signal = [
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE1],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE2],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE3],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE4],
        ]
        signal_summary, verdict = pdwh.all_sector_evaluation(
            smallest_dist_fr, smallest_crit_fr, front_dist_signal, short_dist, obj_signal
        )
...
@teststep_definition(
    ...
    description=(
        "This test step evaluates the right sector static object signals for PDW function when a static obstacle is present iside the sector."
    ),  # this would be shown as a test step description in html report
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
...
@register_signals(ALIAS, Signals)
class TestStepPDWRight(TestStepPDW):
    """testcase that can be tested by a simple pass/fail test.
    This is a required docstring in which you can add more details about what you verify in test step
    ...
    def process(self, **kwargs):
        ...
        obj_signal = [
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE5],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE6],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE7],
            signals_obj._properties[Signals.Columns.OBSTACE_DISTANCE8],
        ]
        signal_summary, verdict = pdwh.all_sector_evaluation(
            smallest_dist_ri, smallest_crit_ri, right_dist_signal, short_dist_le, obj_signal
        )
...
@testcase_definition(
    name="PDW Static obstacle all sectors",
    description=(
        "PDW shall detect all static obstacles around the car, each obstacle situated inside each sector at a distance."
    ),
)
...
@teststep_definition(
    step_number=6,
    name="Static Front sectors",  # this would be shown as a test step name in html report
    description=(
        "This test step evaluates the front sector signals for PDW function when a static obstacle is present iside the sector."
    ),  # this would be shown as a test step description in html report
    expected_result=BooleanResult(
...
@testcase_definition(
    name="PDW Static_Front",
    description=("PDW shall detect all static obstacles in the front side of the car."),
)
# Define the class for test case which will inherit the TestCase class and will return the test steps.
class PDWStaticFront(TestCase):
    """Example test case."""  # required docstring
...
@teststep_definition(
    step_number=7,
    name="Static Right sectors",  # this would be shown as a test step name in html report
    description=(
        "This test step evaluates the right sector signals for PDW function when a static obstacle is present iside the sector."
    ),  # this would be shown as a test step description in html report
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
...
@testcase_definition(
    name="PDW Static_Right",
    description=("PDW shall detect all static obstacles in the right side of the car."),
)
# Define the class for test case which will inherit the TestCase class and will return the test steps.
class PDWStaticRight(TestCase):
    """Example test case."""  # required docstring
...
@teststep_definition(
    step_number=8,
    name="Static Rear sectors",  # this would be shown as a test step name in html report
    description=(
        "This test step evaluates the rear sector signals for PDW function when a static obstacle is present iside the sector."
    ),  # this would be shown as a test step description in html report
    expected_result=BooleanResult(
...
@testcase_definition(
    name="PDW Static_Rear",
    description=("PDW shall detect all static obstacles in the rear side of the car."),
)
# Define the class for test case which will inherit the TestCase class and will return the test steps.
class PDWStaticRear(TestCase):
    """Example test case."""  # required docstring
...
@teststep_definition(
    step_number=9,
    name="Static Left sectors",  # this would be shown as a test step name in html report
    description=(
        "This test step evaluates the left sector signals for PDW function when a static obstacle is present iside the sector."
    ),  # this would be shown as a test step description in html report
    expected_result=BooleanResult(
        TRUE
    ),  # this expected result would be compared with measured_result and give a verdict
...
@testcase_definition(
    name="PDW Static_Left",
    description=("PDW shall detect all obstacles in the left side of the car."),
)
# Define the class for test case which will inherit the TestCase class and will return the test steps.
class PDWStaticLeft(TestCase):
    """Example test case."""  # required docstring
