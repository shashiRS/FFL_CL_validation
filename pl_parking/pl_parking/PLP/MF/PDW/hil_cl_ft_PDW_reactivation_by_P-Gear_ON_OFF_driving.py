...
SIGNAL_DATA = "PDW_REACTIVATION_BY_P-gear_ON_OFF_DRIVING"
...
@teststep_definition(
    step_number=1,
    name="PDW reactivation by PGear while driving",
...
class PDW_reactivation_by_Pgear_driving(TestStep):
    ...
    def process(self, **kwargs):
        ...
        evaluation1 = " ".join(
            ...
            f" after reactivation condition was fulfilled (parking gear ON/OFF).".split()
        )
                ...
                if veh_ignition[frame] and pdw_state[frame] != constants.HilCl.PDW.States.FAILURE:
                    ...
                    if ObjectDetection(frame):
                        ...
                        # Find the moment when vehicle is standstill after it drove a while
                            ...
                            # Find the moment when the vehicle is switched to "Parking Mode"
                            if (
        ...
        if trigger1 is False:
            ...
            preconditions = "Check trigger3! Parking gear was not engaged."
        ...
        if eval_status_ok is None:
            ...
            evaluation1 = " ".join(
                ...
                f" after the following reactivation condition was fulfilled (parking gear ON/OFF).".split()
            )
        else:
            eval_cond = [True] * 1
...
@testcase_definition(
    name="PDW-reactivation by Pgear(parking gear) ON-OFF ,driving situation.",
