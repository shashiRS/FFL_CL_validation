...
SIGNAL_DATA = "PDW_REACTIVATION_BY_IGN_OFF_ON_DRIVING"
...
class PDW_reactivation_by_IGN_driving(TestStep):
    ...
    def process(self, **kwargs):
                ...
                if pdw_state[frame] != constants.HilCl.PDW.States.FAILURE:
                    ...
                    if ObjectDetection(frame):
                        ...
                        # Find the moment when vehicle is standstill after it drove a while
                            ...
                            # Find the moment when the vehicle is switched OFF
                            if not veh_ignition[frame]:
                                trigger3 = True
        ...
        if trigger1 is False:
            ...
            preconditions = "Check trigger3! Ignition wasn't switched OFF."
...
@testcase_definition(
    name="PDW-reactivation by IGN(vehicle ignition) ON-OFF ,driving situation.",
...
class PdwHil(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            PDW_reactivation_by_IGN_driving,
        ]
