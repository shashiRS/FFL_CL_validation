...
SIGNAL_DATA = "PDW_REACTIVATION_BY_EPB_ON_OFF_STANDSTILL"
...
class PDW_reactivation_by_EPB_standstill(TestStep):
    ...
    def process(self, **kwargs):
        ...
        if trigger1 is False:
            ...
            preconditions = f"Check trigger5! EPB(electronic park brake) was not engaged in NEUTRAL gear (automatic-{constants.HilCl.PDW.Gear.Automatic.NEUTRAL} , manual-{constants.HilCl.PDW.Gear.Manual.NEUTRAL})."
...
@testcase_definition(
    name="PDW-reactivation by EPB(electronic parking brake) ON-OFF ,standstill situation.",
...
class PdwHil(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            PDW_reactivation_by_EPB_standstill,
        ]
