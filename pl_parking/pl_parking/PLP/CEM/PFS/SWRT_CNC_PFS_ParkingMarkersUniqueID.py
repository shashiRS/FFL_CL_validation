"""Parking Markers Unique ID Test."""
...
class TestStepFtPCLUniqueID(TestStep):
    ...
    def process(self, **kwargs):
        ...
        result_df = {
            ...
            fc.REQ_ID: ["1530462"],
            fc.TESTCASE_ID: ["39535"],
            fc.TEST_SAFETY_RELEVANT: [fc.NOT_AVAILABLE],
            fc.TEST_DESCRIPTION: [
                "This test checks that CEM provides an identifier for each parking marker, and the identifier is "
...
@verifies("1530462")
@testcase_definition(
    name="SWRT_CNC_PFS_ParkingMarkersUniqueID",
