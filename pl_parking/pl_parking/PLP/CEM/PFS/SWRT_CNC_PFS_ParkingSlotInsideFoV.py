...
SIGNAL_DATA = "PFS_Slot_Field_of_View"
...
class TestStepFtSlotFieldOFView(TestStep):
    ...
    def process(self):
        ...
        result_df = {
            ...
            fc.REQ_ID: ["1530476"],
            fc.TESTCASE_ID: ["38846"],
            fc.TEST_SAFETY_RELEVANT: [fc.NOT_AVAILABLE],
            fc.TEST_DESCRIPTION: [
                f"""This test case checks if CEM output contains only parking slots inside the limited
