...
@teststep_definition(
    step_number=1,
    name="SWRT_CNC_SGF_ConfidenceObjectHigh",
    description="This test case checks that SGF provides the confidence for Static Objects being high and this confidence is between 0 and 1.",
    doors_url="https://jazz.conti.de/qm4/web/console/LIB_L3_SW_TM/_or7dMJpREe6OHr4fEH59Xg#action=com.ibm.rqm.planning.home.actionDispatcher&subAction=viewTestCase&id=38893",
...
class TestStepFtSGFOutputHigh(TestStep):
    ...
    Objective
    ---------
    This test case checks that SGF provides the confidence for Static Objects being high and this confidence is between 0 and 1.
...
class FtSGFOutputHigh(TestCase):
    ...
    def test_steps(self):
        ...
        return [TestStepFtSGFOutputHigh]  # in this list all the needed test steps are included
