#!/usr/bin/env python3
"""SWRT CNC SGF StaticObjectsFromUSSSensor testcases"""
import logging
...
@teststep_definition(
    step_number=1,
    name="Static Objects From USS Sensor",
...
@verifies("1522133, 1522134, 1522140")
@testcase_definition(
...
class StaticObjectsFromUSSSensor(TestCase):
    ...
    def test_steps(self):
        ...
        return [
            TestStepStaticObjectsFromUSSSensor,
        ]
